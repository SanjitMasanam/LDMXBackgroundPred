...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_8()
{
...
//=========  (Mon Feb 23 18:03:05 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx22[4] = { 0.001, 0.01, 0.1, 1 };
   Double_t Graph0_fy22[4] = { 22015, 1545, 182.6562, 25.58594 };
   ...
   TH1F *Graph_Graph022 = new TH1F("Graph_Graph022","",100,0.0009,1.0999);
   ...
   Double_t Graph1_fx23[10] = { 0.001, 0.01, 0.1, 1, 1, 1, 1, 0.1, 0.01, 0.001 };
   Double_t Graph1_fy23[10] = { 25963.95, 4698.1, 251.2588, 40.71061, 40.71061, 19.18945, 19.18945, 134.8517, 844.9219, 10921.5 };
   ...
   TH1F *Graph_Graph123 = new TH1F("Graph_Graph123","Graph",100,0.0009,1.0999);
   Graph_Graph123->SetMinimum(17.27051);
   ...
   Double_t Graph2_fx24[10] = { 0.001, 0.01, 0.1, 1, 1, 1, 1, 0.1, 0.01, 0.001 };
   Double_t Graph2_fy24[10] = { 22015.09, 2139.289, 212.8714, 31.9856, 31.9856, 21.53816, 21.53816, 157.2601, 1123.859, 20454.98 };
   ...
   TH1F *Graph_Graph224 = new TH1F("Graph_Graph224","Graph",100,0.0009,1.0999);
   Graph_Graph224->SetMinimum(19.38435);
   ...
   Double_t Graph0_fx25[4] = { 0.001, 0.01, 0.1, 1 };
   Double_t Graph0_fy25[4] = { 22015, 1545, 182.6562, 25.58594 };
   ...
   TH1F *Graph_Graph025 = new TH1F("Graph_Graph025","",100,0.0009,1.0999);
   ...
   Double_t Graph_fx26[4] = { 0.001, 0.01, 0.1, 1 };
   Double_t Graph_fy26[4] = { 12, 60, 41, 1 };
   ...
   TH1F *Graph_Graph26 = new TH1F("Graph_Graph26","",100,0.0009,1.0999);
   Graph_Graph26->SetMinimum(0.9);
   Graph_Graph26->SetMaximum(65.9);
   ...
   Double_t Graph_fx28[4] = { 0.001, 0.01, 0.1, 1 };
   Double_t Graph_fy28[4] = { 13.2, 66, 45.1, 1.1 };
   ...
   TH1F *Graph_Graph28 = new TH1F("Graph_Graph28","",100,0.0009,1.0999);
   Graph_Graph28->SetMinimum(0.99);
   Graph_Graph28->SetMaximum(72.49);
