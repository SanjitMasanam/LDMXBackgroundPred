...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_1000()
{
...
//=========  (Mon Feb 23 18:03:05 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx99[4] = { 0.001, 0.01, 0.1, 1 };
   Double_t Graph0_fy99[4] = { 22015, 1545, 182.6562, 25.58594 };
   ...
   TH1F *Graph_Graph099 = new TH1F("Graph_Graph099","",100,0.0009,1.0999);
   ...
   Double_t Graph1_fx100[10] = { 0.001, 0.01, 0.1, 1, 1, 1, 1, 0.1, 0.01, 0.001 };
   Double_t Graph1_fy100[10] = { 25963.95, 4698.1, 251.2588, 40.71061, 40.71061, 19.18945, 19.18945, 134.8517, 844.9219, 10921.5 };
   ...
   TH1F *Graph_Graph1100 = new TH1F("Graph_Graph1100","Graph",100,0.0009,1.0999);
   Graph_Graph1100->SetMinimum(17.27051);
   ...
   Double_t Graph2_fx101[10] = { 0.001, 0.01, 0.1, 1, 1, 1, 1, 0.1, 0.01, 0.001 };
   Double_t Graph2_fy101[10] = { 22015.09, 2139.289, 212.8714, 31.9856, 31.9856, 21.53816, 21.53816, 157.2601, 1123.859, 20454.98 };
   ...
   TH1F *Graph_Graph2101 = new TH1F("Graph_Graph2101","Graph",100,0.0009,1.0999);
   Graph_Graph2101->SetMinimum(19.38435);
   ...
   Double_t Graph0_fx102[4] = { 0.001, 0.01, 0.1, 1 };
   Double_t Graph0_fy102[4] = { 22015, 1545, 182.6562, 25.58594 };
   ...
   TH1F *Graph_Graph0102 = new TH1F("Graph_Graph0102","",100,0.0009,1.0999);
   ...
   Double_t Graph_fx103[4] = { 0.001, 0.01, 0.1, 1 };
   Double_t Graph_fy103[4] = { 1500, 7500, 5125, 125 };
   ...
   TH1F *Graph_Graph103 = new TH1F("Graph_Graph103","",100,0.0009,1.0999);
   Graph_Graph103->SetMinimum(112.5);
   Graph_Graph103->SetMaximum(8237.5);
   ...
   Double_t Graph_fx105[4] = { 0.001, 0.01, 0.1, 1 };
   Double_t Graph_fy105[4] = { 1650, 8250, 5637.5, 137.5 };
   ...
   TH1F *Graph_Graph105 = new TH1F("Graph_Graph105","",100,0.0009,1.0999);
   Graph_Graph105->SetMinimum(123.75);
   Graph_Graph105->SetMaximum(9061.25);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(0.00666703,0,0.00666703,4132.489);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(0.00166703,0,"  0.01 GeV");
