...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_2()
{
...
//=========  (Mon Feb 23 18:03:05 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx8[4] = { 0.001, 0.01, 0.1, 1 };
   Double_t Graph0_fy8[4] = { 22015, 1545, 182.6562, 25.58594 };
   ...
   TH1F *Graph_Graph08 = new TH1F("Graph_Graph08","",100,0.0009,1.0999);
   ...
   Double_t Graph1_fx9[10] = { 0.001, 0.01, 0.1, 1, 1, 1, 1, 0.1, 0.01, 0.001 };
   Double_t Graph1_fy9[10] = { 25963.95, 4698.1, 251.2588, 40.71061, 40.71061, 19.18945, 19.18945, 134.8517, 844.9219, 10921.5 };
   ...
   TH1F *Graph_Graph19 = new TH1F("Graph_Graph19","Graph",100,0.0009,1.0999);
   Graph_Graph19->SetMinimum(17.27051);
   ...
   Double_t Graph2_fx10[10] = { 0.001, 0.01, 0.1, 1, 1, 1, 1, 0.1, 0.01, 0.001 };
   Double_t Graph2_fy10[10] = { 22015.09, 2139.289, 212.8714, 31.9856, 31.9856, 21.53816, 21.53816, 157.2601, 1123.859, 20454.98 };
   ...
   TH1F *Graph_Graph210 = new TH1F("Graph_Graph210","Graph",100,0.0009,1.0999);
   Graph_Graph210->SetMinimum(19.38435);
   ...
   Double_t Graph0_fx11[4] = { 0.001, 0.01, 0.1, 1 };
   Double_t Graph0_fy11[4] = { 22015, 1545, 182.6562, 25.58594 };
   ...
   TH1F *Graph_Graph011 = new TH1F("Graph_Graph011","",100,0.0009,1.0999);
   ...
   Double_t Graph_fx12[4] = { 0.001, 0.01, 0.1, 1 };
   Double_t Graph_fy12[4] = { 3, 15, 10.25, 0.25 };
   ...
   TH1F *Graph_Graph12 = new TH1F("Graph_Graph12","",100,0.0009,1.0999);
   Graph_Graph12->SetMinimum(0.225);
   Graph_Graph12->SetMaximum(16.475);
   ...
   Double_t Graph_fx14[4] = { 0.001, 0.01, 0.1, 1 };
   Double_t Graph_fy14[4] = { 3.3, 16.5, 11.275, 0.275 };
   ...
   TH1F *Graph_Graph14 = new TH1F("Graph_Graph14","",100,0.0009,1.0999);
   Graph_Graph14->SetMinimum(0.2475);
   Graph_Graph14->SetMaximum(18.1225);
