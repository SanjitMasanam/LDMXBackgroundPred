...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_30()
{
...
//=========  (Mon Feb 23 18:03:05 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx43[4] = { 0.001, 0.01, 0.1, 1 };
   Double_t Graph0_fy43[4] = { 22015, 1545, 182.6562, 25.58594 };
   ...
   TH1F *Graph_Graph043 = new TH1F("Graph_Graph043","",100,0.0009,1.0999);
   ...
   Double_t Graph1_fx44[10] = { 0.001, 0.01, 0.1, 1, 1, 1, 1, 0.1, 0.01, 0.001 };
   Double_t Graph1_fy44[10] = { 25963.95, 4698.1, 251.2588, 40.71061, 40.71061, 19.18945, 19.18945, 134.8517, 844.9219, 10921.5 };
   ...
   TH1F *Graph_Graph144 = new TH1F("Graph_Graph144","Graph",100,0.0009,1.0999);
   Graph_Graph144->SetMinimum(17.27051);
   ...
   Double_t Graph2_fx45[10] = { 0.001, 0.01, 0.1, 1, 1, 1, 1, 0.1, 0.01, 0.001 };
   Double_t Graph2_fy45[10] = { 22015.09, 2139.289, 212.8714, 31.9856, 31.9856, 21.53816, 21.53816, 157.2601, 1123.859, 20454.98 };
   ...
   TH1F *Graph_Graph245 = new TH1F("Graph_Graph245","Graph",100,0.0009,1.0999);
   Graph_Graph245->SetMinimum(19.38435);
   ...
   Double_t Graph0_fx46[4] = { 0.001, 0.01, 0.1, 1 };
   Double_t Graph0_fy46[4] = { 22015, 1545, 182.6562, 25.58594 };
   ...
   TH1F *Graph_Graph046 = new TH1F("Graph_Graph046","",100,0.0009,1.0999);
   ...
   Double_t Graph_fx47[4] = { 0.001, 0.01, 0.1, 1 };
   Double_t Graph_fy47[4] = { 45, 225, 153.75, 3.75 };
   ...
   TH1F *Graph_Graph47 = new TH1F("Graph_Graph47","",100,0.0009,1.0999);
   Graph_Graph47->SetMinimum(3.375);
   Graph_Graph47->SetMaximum(247.125);
   ...
   Double_t Graph_fx49[4] = { 0.001, 0.01, 0.1, 1 };
   Double_t Graph_fy49[4] = { 49.5, 247.5, 169.125, 4.125 };
   ...
   TH1F *Graph_Graph49 = new TH1F("Graph_Graph49","",100,0.0009,1.0999);
   Graph_Graph49->SetMinimum(3.7125);
   Graph_Graph49->SetMaximum(271.8375);
