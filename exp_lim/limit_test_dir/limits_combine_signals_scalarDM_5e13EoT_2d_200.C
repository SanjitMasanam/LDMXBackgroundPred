...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_200()
{
...
//=========  (Mon Feb 23 18:03:05 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx78[4] = { 0.001, 0.01, 0.1, 1 };
   Double_t Graph0_fy78[4] = { 22015, 1545, 182.6562, 25.58594 };
   ...
   TH1F *Graph_Graph078 = new TH1F("Graph_Graph078","",100,0.0009,1.0999);
   ...
   Double_t Graph1_fx79[10] = { 0.001, 0.01, 0.1, 1, 1, 1, 1, 0.1, 0.01, 0.001 };
   Double_t Graph1_fy79[10] = { 25963.95, 4698.1, 251.2588, 40.71061, 40.71061, 19.18945, 19.18945, 134.8517, 844.9219, 10921.5 };
   ...
   TH1F *Graph_Graph179 = new TH1F("Graph_Graph179","Graph",100,0.0009,1.0999);
   Graph_Graph179->SetMinimum(17.27051);
   ...
   Double_t Graph2_fx80[10] = { 0.001, 0.01, 0.1, 1, 1, 1, 1, 0.1, 0.01, 0.001 };
   Double_t Graph2_fy80[10] = { 22015.09, 2139.289, 212.8714, 31.9856, 31.9856, 21.53816, 21.53816, 157.2601, 1123.859, 20454.98 };
   ...
   TH1F *Graph_Graph280 = new TH1F("Graph_Graph280","Graph",100,0.0009,1.0999);
   Graph_Graph280->SetMinimum(19.38435);
   ...
   Double_t Graph0_fx81[4] = { 0.001, 0.01, 0.1, 1 };
   Double_t Graph0_fy81[4] = { 22015, 1545, 182.6562, 25.58594 };
   ...
   TH1F *Graph_Graph081 = new TH1F("Graph_Graph081","",100,0.0009,1.0999);
   ...
   Double_t Graph_fx82[4] = { 0.001, 0.01, 0.1, 1 };
   Double_t Graph_fy82[4] = { 300, 1500, 1025, 25 };
   ...
   TH1F *Graph_Graph82 = new TH1F("Graph_Graph82","",100,0.0009,1.0999);
   Graph_Graph82->SetMinimum(22.5);
   Graph_Graph82->SetMaximum(1647.5);
   ...
   Double_t Graph_fx84[4] = { 0.001, 0.01, 0.1, 1 };
   Double_t Graph_fy84[4] = { 330, 1650, 1127.5, 27.5 };
   ...
   TH1F *Graph_Graph84 = new TH1F("Graph_Graph84","",100,0.0009,1.0999);
   Graph_Graph84->SetMinimum(24.75);
   Graph_Graph84->SetMaximum(1812.25);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(0.01151635,0,0.01151635,1490.408);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(0.006516354,0,"  0.01 GeV");
