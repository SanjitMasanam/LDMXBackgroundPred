...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_5()
{
...
//=========  (Mon Feb 23 18:03:05 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx15[4] = { 0.001, 0.01, 0.1, 1 };
   Double_t Graph0_fy15[4] = { 22015, 1545, 182.6562, 25.58594 };
   ...
   TH1F *Graph_Graph015 = new TH1F("Graph_Graph015","",100,0.0009,1.0999);
   ...
   Double_t Graph1_fx16[10] = { 0.001, 0.01, 0.1, 1, 1, 1, 1, 0.1, 0.01, 0.001 };
   Double_t Graph1_fy16[10] = { 25963.95, 4698.1, 251.2588, 40.71061, 40.71061, 19.18945, 19.18945, 134.8517, 844.9219, 10921.5 };
   ...
   TH1F *Graph_Graph116 = new TH1F("Graph_Graph116","Graph",100,0.0009,1.0999);
   Graph_Graph116->SetMinimum(17.27051);
   ...
   Double_t Graph2_fx17[10] = { 0.001, 0.01, 0.1, 1, 1, 1, 1, 0.1, 0.01, 0.001 };
   Double_t Graph2_fy17[10] = { 22015.09, 2139.289, 212.8714, 31.9856, 31.9856, 21.53816, 21.53816, 157.2601, 1123.859, 20454.98 };
   ...
   TH1F *Graph_Graph217 = new TH1F("Graph_Graph217","Graph",100,0.0009,1.0999);
   Graph_Graph217->SetMinimum(19.38435);
   ...
   Double_t Graph0_fx18[4] = { 0.001, 0.01, 0.1, 1 };
   Double_t Graph0_fy18[4] = { 22015, 1545, 182.6562, 25.58594 };
   ...
   TH1F *Graph_Graph018 = new TH1F("Graph_Graph018","",100,0.0009,1.0999);
   ...
   Double_t Graph_fx19[4] = { 0.001, 0.01, 0.1, 1 };
   Double_t Graph_fy19[4] = { 7.5, 37.5, 25.625, 0.625 };
   ...
   TH1F *Graph_Graph19 = new TH1F("Graph_Graph19","",100,0.0009,1.0999);
   Graph_Graph19->SetMinimum(0.5625);
   Graph_Graph19->SetMaximum(41.1875);
   ...
   Double_t Graph_fx21[4] = { 0.001, 0.01, 0.1, 1 };
   Double_t Graph_fy21[4] = { 8.25, 41.25, 28.1875, 0.6875 };
   ...
   TH1F *Graph_Graph21 = new TH1F("Graph_Graph21","",100,0.0009,1.0999);
   Graph_Graph21->SetMinimum(0.61875);
   Graph_Graph21->SetMaximum(45.30625);
