...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_10()
{
...
//=========  (Mon Feb 23 18:03:05 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx29[4] = { 0.001, 0.01, 0.1, 1 };
   Double_t Graph0_fy29[4] = { 22015, 1545, 182.6562, 25.58594 };
   ...
   TH1F *Graph_Graph029 = new TH1F("Graph_Graph029","",100,0.0009,1.0999);
   ...
   Double_t Graph1_fx30[10] = { 0.001, 0.01, 0.1, 1, 1, 1, 1, 0.1, 0.01, 0.001 };
   Double_t Graph1_fy30[10] = { 25963.95, 4698.1, 251.2588, 40.71061, 40.71061, 19.18945, 19.18945, 134.8517, 844.9219, 10921.5 };
   ...
   TH1F *Graph_Graph130 = new TH1F("Graph_Graph130","Graph",100,0.0009,1.0999);
   Graph_Graph130->SetMinimum(17.27051);
   ...
   Double_t Graph2_fx31[10] = { 0.001, 0.01, 0.1, 1, 1, 1, 1, 0.1, 0.01, 0.001 };
   Double_t Graph2_fy31[10] = { 22015.09, 2139.289, 212.8714, 31.9856, 31.9856, 21.53816, 21.53816, 157.2601, 1123.859, 20454.98 };
   ...
   TH1F *Graph_Graph231 = new TH1F("Graph_Graph231","Graph",100,0.0009,1.0999);
   Graph_Graph231->SetMinimum(19.38435);
   ...
   Double_t Graph0_fx32[4] = { 0.001, 0.01, 0.1, 1 };
   Double_t Graph0_fy32[4] = { 22015, 1545, 182.6562, 25.58594 };
   ...
   TH1F *Graph_Graph032 = new TH1F("Graph_Graph032","",100,0.0009,1.0999);
   ...
   Double_t Graph_fx33[4] = { 0.001, 0.01, 0.1, 1 };
   Double_t Graph_fy33[4] = { 15, 75, 51.25, 1.25 };
   ...
   TH1F *Graph_Graph33 = new TH1F("Graph_Graph33","",100,0.0009,1.0999);
   Graph_Graph33->SetMinimum(1.125);
   Graph_Graph33->SetMaximum(82.375);
   ...
   Double_t Graph_fx35[4] = { 0.001, 0.01, 0.1, 1 };
   Double_t Graph_fy35[4] = { 16.5, 82.5, 56.375, 1.375 };
   ...
   TH1F *Graph_Graph35 = new TH1F("Graph_Graph35","",100,0.0009,1.0999);
   Graph_Graph35->SetMinimum(1.2375);
   Graph_Graph35->SetMaximum(90.6125);
