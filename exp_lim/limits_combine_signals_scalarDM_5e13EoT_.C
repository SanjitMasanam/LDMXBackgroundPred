...
#endif
void limits_combine_signals_scalarDM_5e13EoT_()
{
//=========Macro generated from canvas: climits/climits
//=========  (Mon Feb 23 17:28:38 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx1[4] = { 0.001, 0.01, 0.1, 1 };
   Double_t Graph0_fy1[4] = { 22015, 1545, 182.6562, 25.58594 };
   ...
   TH1F *Graph_Graph01 = new TH1F("Graph_Graph01","",100,0.0009,1.0999);
   ...
   Graph_Graph01->GetYaxis()->SetTitle("N_{Sig} at y_{ref}");
   ...
   Double_t Graph1_fx2[10] = { 0.001, 0.01, 0.1, 1, 1, 1, 1, 0.1, 0.01, 0.001 };
   Double_t Graph1_fy2[10] = { 25963.95, 4698.1, 251.2588, 40.71061, 40.71061, 19.18945, 19.18945, 134.8517, 844.9219, 10921.5 };
   ...
   TH1F *Graph_Graph12 = new TH1F("Graph_Graph12","Graph",100,0.0009,1.0999);
   Graph_Graph12->SetMinimum(17.27051);
   ...
   Double_t Graph2_fx3[10] = { 0.001, 0.01, 0.1, 1, 1, 1, 1, 0.1, 0.01, 0.001 };
   Double_t Graph2_fy3[10] = { 22015.09, 2139.289, 212.8714, 31.9856, 31.9856, 21.53816, 21.53816, 157.2601, 1123.859, 20454.98 };
   ...
   TH1F *Graph_Graph23 = new TH1F("Graph_Graph23","Graph",100,0.0009,1.0999);
   Graph_Graph23->SetMinimum(19.38435);
   ...
   Double_t Graph0_fx4[4] = { 0.001, 0.01, 0.1, 1 };
   Double_t Graph0_fy4[4] = { 22015, 1545, 182.6562, 25.58594 };
   ...
   TH1F *Graph_Graph04 = new TH1F("Graph_Graph04","",100,0.0009,1.0999);
   ...
   Graph_Graph04->GetYaxis()->SetTitle("N_{Sig} at y_{ref}");
   ...
   Double_t Graph_fx5[4] = { 0.001, 0.01, 0.1, 1 };
   Double_t Graph_fy5[4] = { 1.5, 7.5, 5.125, 0.125 };
   ...
   TH1F *Graph_Graph5 = new TH1F("Graph_Graph5","",100,0.0009,1.0999);
   Graph_Graph5->SetMinimum(0.1125);
   Graph_Graph5->SetMaximum(8.2375);
   ...
   Double_t Graph_fx6[4] = { 0.001, 0.01, 0.1, 1 };
   Double_t Graph_fy6[4] = { 1.35, 6.75, 4.6125, 0.1125 };
   ...
   TH1F *Graph_Graph6 = new TH1F("Graph_Graph6","",100,0.0009,1.0999);
   Graph_Graph6->SetMinimum(0.10125);
   Graph_Graph6->SetMaximum(7.41375);
   ...
   Double_t Graph_fx7[4] = { 0.001, 0.01, 0.1, 1 };
   Double_t Graph_fy7[4] = { 1.65, 8.25, 5.6375, 0.1375 };
   ...
   TH1F *Graph_Graph7 = new TH1F("Graph_Graph7","",100,0.0009,1.0999);
   Graph_Graph7->SetMinimum(0.12375);
   Graph_Graph7->SetMaximum(9.06125);
   ...
   Graph_copy->GetYaxis()->SetTitle("N_{Sig} at y_{ref}");
