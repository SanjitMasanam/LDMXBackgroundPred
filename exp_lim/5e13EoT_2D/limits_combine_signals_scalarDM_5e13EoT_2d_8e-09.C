...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_8e-09()
{
...
//=========  (Tue Feb 24 10:30:54 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx22[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph0_fy22[4] = { 22015, 1525, 185.1562, 26.17188 };
   TGraph *graph = new TGraph(4,Graph0_fx22,Graph0_fy22);
   ...
   TH1F *Graph_Graph022 = new TH1F("Graph_Graph022","",100,0.0002997,0.366633);
   ...
   Graph_Graph022->GetXaxis()->SetTitle("m(#chi) [GeV]");
   Graph_Graph022->GetXaxis()->SetRange(0,101);
   ...
   Graph_Graph022->GetYaxis()->SetTitle("N_{Sig}");
   ...
   Double_t Graph1_fx23[10] = { 0.000333, 0.003333, 0.033333, 0.333333, 0.333333, 0.333333, 0.333333, 0.033333, 0.003333, 0.000333 };
   Double_t Graph1_fy23[10] = { 25974.92, 4637.283, 253.7817, 41.44204, 41.44204, 19.73114, 19.73114, 138.8672, 833.9844, 10663.52 };
   ...
   TH1F *Graph_Graph123 = new TH1F("Graph_Graph123","Graph",100,0.0002997,0.366633);
   Graph_Graph123->SetMinimum(17.75803);
   Graph_Graph123->SetMaximum(28570.44);
   ...
   Double_t Graph2_fx24[10] = { 0.000333, 0.003333, 0.033333, 0.333333, 0.333333, 0.333333, 0.333333, 0.033333, 0.003333, 0.000333 };
   Double_t Graph2_fy24[10] = { 22015.09, 2111.596, 215.2314, 32.63985, 32.63985, 22.0961, 22.0961, 161.2885, 1109.311, 20374.36 };
   ...
   TH1F *Graph_Graph224 = new TH1F("Graph_Graph224","Graph",100,0.0002997,0.366633);
   Graph_Graph224->SetMinimum(19.88649);
   Graph_Graph224->SetMaximum(24214.38);
   ...
   Double_t Graph0_fx25[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph0_fy25[4] = { 22015, 1525, 185.1562, 26.17188 };
   graph = new TGraph(4,Graph0_fx25,Graph0_fy25);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph025 = new TH1F("Graph_Graph025","",100,0.0002997,0.366633);
   ...
   Graph_Graph025->GetXaxis()->SetTitle("m(#chi) [GeV]");
   Graph_Graph025->GetXaxis()->SetRange(0,101);
   ...
   Graph_Graph025->GetYaxis()->SetTitle("N_{Sig}");
   ...
   Double_t Graph_fx26[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph_fy26[4] = { 135.8483, 4.560074, 0.0242198, 1.278545e-07 };
   ...
   TH1F *Graph_Graph26 = new TH1F("Graph_Graph26","",100,0.0002997,0.366633);
   Graph_Graph26->SetMinimum(1.150691e-07);
   Graph_Graph26->SetMaximum(149.4331);
   ...
   Double_t Graph_fx28[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph_fy28[4] = { 149.4331, 5.016081, 0.02664178, 1.4064e-07 };
   ...
   TH1F *Graph_Graph28 = new TH1F("Graph_Graph28","",100,0.0002997,0.366633);
   Graph_Graph28->SetMinimum(1.26576e-07);
   Graph_Graph28->SetMaximum(164.3764);
