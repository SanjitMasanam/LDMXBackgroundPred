...
//=========  (Mon Mar  2 03:15:03 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx463[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph0_fy463[4] = { 22015, 1547.5, 182.5, 25.54688 };
   TGraph *graph = new TGraph(4,Graph0_fx463,Graph0_fy463);
   ...
   TH1F *Graph_Graph0463 = new TH1F("Graph_Graph0463","",100,0,0.366633);
   ...
   Graph_Graph0463->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0463->GetXaxis()->SetRange(1,100);
   ...
   Graph_Graph0463->GetYaxis()->SetTitle("N_{sig}");
   ...
   Double_t Graph1_fx464[10] = { 0.000333, 0.003333, 0.033333, 0.333333, 0.333333, 0.333333, 0.333333, 0.033333, 0.003333, 0.000333 };
   Double_t Graph1_fy464[10] = { 25963.95, 4705.702, 251.1274, 40.66906, 40.66906, 19.16016, 19.16016, 134.7363, 846.2891, 10921.5 };
   graph = new TGraph(10,Graph1_fx464,Graph1_fy464);
   ...
   TH1F *Graph_Graph1464 = new TH1F("Graph_Graph1464","Graph",100,0,0.366633);
   Graph_Graph1464->SetMinimum(17.24414);
   Graph_Graph1464->SetMaximum(28558.43);
   ...
   Double_t Graph2_fx465[10] = { 0.000333, 0.003333, 0.033333, 0.333333, 0.333333, 0.333333, 0.333333, 0.033333, 0.003333, 0.000333 };
   Double_t Graph2_fy465[10] = { 22015.09, 2139.667, 212.6893, 31.96222, 31.96222, 21.55518, 21.55518, 157.1255, 1120.2, 20454.98 };
   graph = new TGraph(10,Graph2_fx465,Graph2_fy465);
   ...
   TH1F *Graph_Graph2465 = new TH1F("Graph_Graph2465","Graph",100,0,0.366633);
   Graph_Graph2465->SetMinimum(19.39966);
   Graph_Graph2465->SetMaximum(24214.44);
   ...
   Double_t Graph0_fx466[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph0_fy466[4] = { 22015, 1547.5, 182.5, 25.54688 };
   graph = new TGraph(4,Graph0_fx466,Graph0_fy466);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0466 = new TH1F("Graph_Graph0466","",100,0,0.366633);
   ...
   Graph_Graph0466->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0466->GetXaxis()->SetRange(1,100);
   ...
   Graph_Graph0466->GetYaxis()->SetTitle("N_{sig}");
   ...
   Double_t Graph_fx467[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph_fy467[4] = { 7235564, 243165.9, 1290.933, 0.06800849 };
   graph = new TGraph(4,Graph_fx467,Graph_fy467);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph467 = new TH1F("Graph_Graph467","",100,0,0.366633);
   Graph_Graph467->SetMinimum(0.06120764);
   Graph_Graph467->SetMaximum(7959121);
   ...
   Double_t Graph_fx469[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph_fy469[4] = { 7959121, 267482.5, 1420.027, 0.07480934 };
   graph = new TGraph(4,Graph_fx469,Graph_fy469);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph469 = new TH1F("Graph_Graph469","",100,0,0.366633);
   Graph_Graph469->SetMinimum(0.06732841);
   Graph_Graph469->SetMaximum(8755033);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(0.1077668,0,0.1077668,112.0452);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(0.1027668,0,"  0.11 TeV");
