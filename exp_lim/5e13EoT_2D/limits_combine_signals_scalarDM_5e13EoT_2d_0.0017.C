...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_0.0017()
{
...
//=========  (Mon Mar  2 03:15:02 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx302[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph0_fy302[4] = { 22015, 1547.5, 182.5, 25.54688 };
   TGraph *graph = new TGraph(4,Graph0_fx302,Graph0_fy302);
   ...
   TH1F *Graph_Graph0302 = new TH1F("Graph_Graph0302","",100,0,0.366633);
   ...
   Graph_Graph0302->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0302->GetXaxis()->SetRange(1,100);
   ...
   Graph_Graph0302->GetYaxis()->SetTitle("N_{sig}");
   ...
   Double_t Graph1_fx303[10] = { 0.000333, 0.003333, 0.033333, 0.333333, 0.333333, 0.333333, 0.333333, 0.033333, 0.003333, 0.000333 };
   Double_t Graph1_fy303[10] = { 25963.95, 4705.702, 251.1274, 40.66906, 40.66906, 19.16016, 19.16016, 134.7363, 846.2891, 10921.5 };
   graph = new TGraph(10,Graph1_fx303,Graph1_fy303);
   ...
   TH1F *Graph_Graph1303 = new TH1F("Graph_Graph1303","Graph",100,0,0.366633);
   Graph_Graph1303->SetMinimum(17.24414);
   Graph_Graph1303->SetMaximum(28558.43);
   ...
   Double_t Graph2_fx304[10] = { 0.000333, 0.003333, 0.033333, 0.333333, 0.333333, 0.333333, 0.333333, 0.033333, 0.003333, 0.000333 };
   Double_t Graph2_fy304[10] = { 22015.09, 2139.667, 212.6893, 31.96222, 31.96222, 21.55518, 21.55518, 157.1255, 1120.2, 20454.98 };
   graph = new TGraph(10,Graph2_fx304,Graph2_fy304);
   ...
   TH1F *Graph_Graph2304 = new TH1F("Graph_Graph2304","Graph",100,0,0.366633);
   Graph_Graph2304->SetMinimum(19.39966);
   Graph_Graph2304->SetMaximum(24214.44);
   ...
   Double_t Graph0_fx305[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph0_fy305[4] = { 22015, 1547.5, 182.5, 25.54688 };
   graph = new TGraph(4,Graph0_fx305,Graph0_fy305);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0305 = new TH1F("Graph_Graph0305","",100,0,0.366633);
   ...
   Graph_Graph0305->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0305->GetXaxis()->SetRange(1,100);
   ...
   Graph_Graph0305->GetYaxis()->SetTitle("N_{sig}");
   ...
   Double_t Graph_fx306[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph_fy306[4] = { 307511.5, 10334.55, 54.86466, 0.002890361 };
   graph = new TGraph(4,Graph_fx306,Graph_fy306);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph306 = new TH1F("Graph_Graph306","",100,0,0.366633);
   Graph_Graph306->SetMinimum(0.002601325);
   Graph_Graph306->SetMaximum(338262.6);
   ...
   Double_t Graph_fx308[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph_fy308[4] = { 338262.6, 11368.01, 60.35113, 0.003179397 };
   graph = new TGraph(4,Graph_fx308,Graph_fy308);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph308 = new TH1F("Graph_Graph308","",100,0,0.366633);
   Graph_Graph308->SetMinimum(0.002861457);
   Graph_Graph308->SetMaximum(372088.9);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(0.02170464,0,0.02170464,417.9355);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(0.01670464,0,"  0.02 TeV");
