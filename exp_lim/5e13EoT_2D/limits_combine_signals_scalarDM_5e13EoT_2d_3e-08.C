...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_3e-08()
{
...
//=========  (Tue Feb 24 10:30:55 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy43[4] = { 22015, 1525, 185.1562, 26.17188 };
   ...
   TH1F *Graph_Graph043 = new TH1F("Graph_Graph043","",100,0.0002997,0.366633);
   ...
   Graph_Graph043->GetXaxis()->SetTitle("m(#chi) [GeV]");
   Graph_Graph043->GetXaxis()->SetRange(0,101);
   ...
   Double_t Graph1_fy44[10] = { 25974.92, 4637.283, 253.7817, 41.44204, 41.44204, 19.73114, 19.73114, 138.8672, 833.9844, 10663.52 };
   ...
   TH1F *Graph_Graph144 = new TH1F("Graph_Graph144","Graph",100,0.0002997,0.366633);
   Graph_Graph144->SetMinimum(17.75803);
   Graph_Graph144->SetMaximum(28570.44);
   ...
   Double_t Graph2_fy45[10] = { 22015.09, 2111.596, 215.2314, 32.63985, 32.63985, 22.0961, 22.0961, 161.2885, 1109.311, 20374.36 };
   ...
   TH1F *Graph_Graph245 = new TH1F("Graph_Graph245","Graph",100,0.0002997,0.366633);
   Graph_Graph245->SetMinimum(19.88649);
   Graph_Graph245->SetMaximum(24214.38);
   ...
   Double_t Graph0_fy46[4] = { 22015, 1525, 185.1562, 26.17188 };
   ...
   TH1F *Graph_Graph046 = new TH1F("Graph_Graph046","",100,0.0002997,0.366633);
   ...
   Graph_Graph046->GetXaxis()->SetTitle("m(#chi) [GeV]");
   Graph_Graph046->GetXaxis()->SetRange(0,101);
   ...
   Double_t Graph_fy47[4] = { 509.4311, 17.10028, 0.09082427, 4.794544e-07 };
   ...
   TH1F *Graph_Graph47 = new TH1F("Graph_Graph47","",100,0.0002997,0.366633);
   Graph_Graph47->SetMinimum(4.31509e-07);
   Graph_Graph47->SetMaximum(560.3742);
   ...
   Double_t Graph_fy49[4] = { 560.3742, 18.8103, 0.09990669, 5.273999e-07 };
   ...
   TH1F *Graph_Graph49 = new TH1F("Graph_Graph49","",100,0.0002997,0.366633);
   Graph_Graph49->SetMinimum(4.746599e-07);
   Graph_Graph49->SetMaximum(616.4116);
