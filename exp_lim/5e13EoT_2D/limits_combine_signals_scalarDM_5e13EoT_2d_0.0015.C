...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_0.0015()
{
...
//=========  (Mon Mar  2 03:15:02 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy288[4] = { 22015, 1547.5, 182.5, 25.54688 };
   ...
   TH1F *Graph_Graph0288 = new TH1F("Graph_Graph0288","",100,0,0.366633);
   ...
   Graph_Graph0288->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0288->GetXaxis()->SetRange(1,100);
   ...
   Double_t Graph1_fy289[10] = { 25963.95, 4705.702, 251.1274, 40.66906, 40.66906, 19.16016, 19.16016, 134.7363, 846.2891, 10921.5 };
   ...
   TH1F *Graph_Graph1289 = new TH1F("Graph_Graph1289","Graph",100,0,0.366633);
   Graph_Graph1289->SetMinimum(17.24414);
   Graph_Graph1289->SetMaximum(28558.43);
   ...
   Double_t Graph2_fy290[10] = { 22015.09, 2139.667, 212.6893, 31.96222, 31.96222, 21.55518, 21.55518, 157.1255, 1120.2, 20454.98 };
   ...
   TH1F *Graph_Graph2290 = new TH1F("Graph_Graph2290","Graph",100,0,0.366633);
   Graph_Graph2290->SetMinimum(19.39966);
   Graph_Graph2290->SetMaximum(24214.44);
   ...
   Double_t Graph0_fy291[4] = { 22015, 1547.5, 182.5, 25.54688 };
   ...
   TH1F *Graph_Graph0291 = new TH1F("Graph_Graph0291","",100,0,0.366633);
   ...
   Graph_Graph0291->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0291->GetXaxis()->SetRange(1,100);
   ...
   Double_t Graph_fy292[4] = { 271333.7, 9118.721, 48.41, 0.002550319 };
   ...
   TH1F *Graph_Graph292 = new TH1F("Graph_Graph292","",100,0,0.366633);
   Graph_Graph292->SetMinimum(0.002295287);
   Graph_Graph292->SetMaximum(298467);
   ...
   Double_t Graph_fy294[4] = { 298467, 10030.59, 53.251, 0.00280535 };
   ...
   TH1F *Graph_Graph294 = new TH1F("Graph_Graph294","",100,0,0.366633);
   Graph_Graph294->SetMinimum(0.002524815);
   Graph_Graph294->SetMaximum(328313.7);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(0.02049367,0,0.02049367,455.5997);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(0.01549367,0,"  0.02 TeV");
