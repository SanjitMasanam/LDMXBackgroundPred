...
//=========  (Tue Feb 24 10:30:57 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy295[4] = { 22015, 1525, 185.1562, 26.17188 };
   ...
   TH1F *Graph_Graph0295 = new TH1F("Graph_Graph0295","",100,0.0002997,0.366633);
   ...
   Graph_Graph0295->GetXaxis()->SetTitle("m(#chi) [GeV]");
   Graph_Graph0295->GetXaxis()->SetRange(0,101);
   ...
   Double_t Graph1_fy296[10] = { 25974.92, 4637.283, 253.7817, 41.44204, 41.44204, 19.73114, 19.73114, 138.8672, 833.9844, 10663.52 };
   ...
   TH1F *Graph_Graph1296 = new TH1F("Graph_Graph1296","Graph",100,0.0002997,0.366633);
   Graph_Graph1296->SetMinimum(17.75803);
   Graph_Graph1296->SetMaximum(28570.44);
   ...
   Double_t Graph2_fy297[10] = { 22015.09, 2111.596, 215.2314, 32.63985, 32.63985, 22.0961, 22.0961, 161.2885, 1109.311, 20374.36 };
   ...
   TH1F *Graph_Graph2297 = new TH1F("Graph_Graph2297","Graph",100,0.0002997,0.366633);
   Graph_Graph2297->SetMinimum(19.88649);
   Graph_Graph2297->SetMaximum(24214.38);
   ...
   Double_t Graph0_fy298[4] = { 22015, 1525, 185.1562, 26.17188 };
   ...
   TH1F *Graph_Graph0298 = new TH1F("Graph_Graph0298","",100,0.0002997,0.366633);
   ...
   Graph_Graph0298->GetXaxis()->SetTitle("m(#chi) [GeV]");
   Graph_Graph0298->GetXaxis()->SetRange(0,101);
   ...
   Double_t Graph_fy299[4] = { 1.698104e+10, 5.700092e+08, 3027476, 15.98181 };
   ...
   TH1F *Graph_Graph299 = new TH1F("Graph_Graph299","",100,0.0002997,0.366633);
   Graph_Graph299->SetMinimum(14.38363);
   Graph_Graph299->SetMaximum(1.867914e+10);
   ...
   Double_t Graph_fy301[4] = { 1.867914e+10, 6.270102e+08, 3330223, 17.58 };
   ...
   TH1F *Graph_Graph301 = new TH1F("Graph_Graph301","",100,0.0002997,0.366633);
   Graph_Graph301->SetMinimum(15.822);
   Graph_Graph301->SetMaximum(2.054705e+10);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(0.3188194,0,0.3188194,28.77017);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(0.3138194,0,"  0.32 GeV");
