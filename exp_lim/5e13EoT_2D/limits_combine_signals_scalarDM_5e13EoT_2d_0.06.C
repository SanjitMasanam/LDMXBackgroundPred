...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_0.06()
{
...
//=========  (Mon Mar  2 03:15:03 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx477[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph0_fy477[4] = { 22015, 1547.5, 182.5, 25.54688 };
   TGraph *graph = new TGraph(4,Graph0_fx477,Graph0_fy477);
   ...
   TH1F *Graph_Graph0477 = new TH1F("Graph_Graph0477","",100,0,0.366633);
   ...
   Graph_Graph0477->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0477->GetXaxis()->SetRange(1,100);
   ...
   Graph_Graph0477->GetYaxis()->SetTitle("N_{sig}");
   ...
   Double_t Graph1_fx478[10] = { 0.000333, 0.003333, 0.033333, 0.333333, 0.333333, 0.333333, 0.333333, 0.033333, 0.003333, 0.000333 };
   Double_t Graph1_fy478[10] = { 25963.95, 4705.702, 251.1274, 40.66906, 40.66906, 19.16016, 19.16016, 134.7363, 846.2891, 10921.5 };
   graph = new TGraph(10,Graph1_fx478,Graph1_fy478);
   ...
   TH1F *Graph_Graph1478 = new TH1F("Graph_Graph1478","Graph",100,0,0.366633);
   Graph_Graph1478->SetMinimum(17.24414);
   Graph_Graph1478->SetMaximum(28558.43);
   ...
   Double_t Graph2_fx479[10] = { 0.000333, 0.003333, 0.033333, 0.333333, 0.333333, 0.333333, 0.333333, 0.033333, 0.003333, 0.000333 };
   Double_t Graph2_fy479[10] = { 22015.09, 2139.667, 212.6893, 31.96222, 31.96222, 21.55518, 21.55518, 157.1255, 1120.2, 20454.98 };
   graph = new TGraph(10,Graph2_fx479,Graph2_fy479);
   ...
   TH1F *Graph_Graph2479 = new TH1F("Graph_Graph2479","Graph",100,0,0.366633);
   Graph_Graph2479->SetMinimum(19.39966);
   Graph_Graph2479->SetMaximum(24214.44);
   ...
   Double_t Graph0_fx480[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph0_fy480[4] = { 22015, 1547.5, 182.5, 25.54688 };
   graph = new TGraph(4,Graph0_fx480,Graph0_fy480);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0480 = new TH1F("Graph_Graph0480","",100,0,0.366633);
   ...
   Graph_Graph0480->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0480->GetXaxis()->SetRange(1,100);
   ...
   Graph_Graph0480->GetYaxis()->SetTitle("N_{sig}");
   ...
   Double_t Graph_fx481[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph_fy481[4] = { 1.085335e+07, 364748.8, 1936.4, 0.1020127 };
   graph = new TGraph(4,Graph_fx481,Graph_fy481);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph481 = new TH1F("Graph_Graph481","",100,0,0.366633);
   Graph_Graph481->SetMinimum(0.09181147);
   Graph_Graph481->SetMaximum(1.193868e+07);
   ...
   Double_t Graph_fx483[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph_fy483[4] = { 1.193868e+07, 401223.7, 2130.04, 0.112214 };
   graph = new TGraph(4,Graph_fx483,Graph_fy483);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph483 = new TH1F("Graph_Graph483","",100,0,0.366633);
   Graph_Graph483->SetMinimum(0.1009926);
   Graph_Graph483->SetMaximum(1.313255e+07);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(0.1231935,0,0.1231935,101.2704);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(0.1181935,0,"  0.12 TeV");
