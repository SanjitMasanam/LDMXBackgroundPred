...
//=========  (Mon Mar  2 03:15:02 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy71[4] = { 22015, 1547.5, 182.5, 25.54688 };
   ...
   TH1F *Graph_Graph071 = new TH1F("Graph_Graph071","",100,0,0.366633);
   ...
   Graph_Graph071->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph071->GetXaxis()->SetRange(1,100);
   ...
   Double_t Graph1_fy72[10] = { 25963.95, 4705.702, 251.1274, 40.66906, 40.66906, 19.16016, 19.16016, 134.7363, 846.2891, 10921.5 };
   ...
   TH1F *Graph_Graph172 = new TH1F("Graph_Graph172","Graph",100,0,0.366633);
   Graph_Graph172->SetMinimum(17.24414);
   ...
   Double_t Graph2_fy73[10] = { 22015.09, 2139.667, 212.6893, 31.96222, 31.96222, 21.55518, 21.55518, 157.1255, 1120.2, 20454.98 };
   ...
   TH1F *Graph_Graph273 = new TH1F("Graph_Graph273","Graph",100,0,0.366633);
   Graph_Graph273->SetMinimum(19.39966);
   ...
   Double_t Graph0_fy74[4] = { 22015, 1547.5, 182.5, 25.54688 };
   ...
   TH1F *Graph_Graph074 = new TH1F("Graph_Graph074","",100,0,0.366633);
   ...
   Graph_Graph074->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph074->GetXaxis()->SetRange(1,100);
   ...
   Double_t Graph_fy75[4] = { 3617.782, 121.5829, 0.6454666, 3.400425e-05 };
   ...
   TH1F *Graph_Graph75 = new TH1F("Graph_Graph75","",100,0,0.366633);
   Graph_Graph75->SetMinimum(3.060382e-05);
   Graph_Graph75->SetMaximum(3979.56);
   ...
   Double_t Graph_fy77[4] = { 3979.56, 133.7412, 0.7100133, 3.740467e-05 };
   ...
   TH1F *Graph_Graph77 = new TH1F("Graph_Graph77","",100,0,0.366633);
   Graph_Graph77->SetMinimum(3.36642e-05);
   Graph_Graph77->SetMaximum(4377.516);
