...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_1e-06()
{
...
//=========  (Tue Feb 24 10:30:55 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy99[4] = { 22015, 1525, 185.1562, 26.17188 };
   ...
   TH1F *Graph_Graph099 = new TH1F("Graph_Graph099","",100,0.0002997,0.366633);
   ...
   Graph_Graph099->GetXaxis()->SetTitle("m(#chi) [GeV]");
   ...
   Double_t Graph1_fy100[10] = { 25974.92, 4637.283, 253.7817, 41.44204, 41.44204, 19.73114, 19.73114, 138.8672, 833.9844, 10663.52 };
   ...
   TH1F *Graph_Graph1100 = new TH1F("Graph_Graph1100","Graph",100,0.0002997,0.366633);
   Graph_Graph1100->SetMinimum(17.75803);
   Graph_Graph1100->SetMaximum(28570.44);
   ...
   Double_t Graph2_fy101[10] = { 22015.09, 2111.596, 215.2314, 32.63985, 32.63985, 22.0961, 22.0961, 161.2885, 1109.311, 20374.36 };
   ...
   TH1F *Graph_Graph2101 = new TH1F("Graph_Graph2101","Graph",100,0.0002997,0.366633);
   Graph_Graph2101->SetMinimum(19.88649);
   Graph_Graph2101->SetMaximum(24214.38);
   ...
   Double_t Graph0_fy102[4] = { 22015, 1525, 185.1562, 26.17188 };
   ...
   TH1F *Graph_Graph0102 = new TH1F("Graph_Graph0102","",100,0.0002997,0.366633);
   ...
   Graph_Graph0102->GetXaxis()->SetTitle("m(#chi) [GeV]");
   ...
   Double_t Graph_fy103[4] = { 16981.04, 570.0092, 3.027476, 1.598181e-05 };
   ...
   TH1F *Graph_Graph103 = new TH1F("Graph_Graph103","",100,0.0002997,0.366633);
   Graph_Graph103->SetMinimum(1.438363e-05);
   Graph_Graph103->SetMaximum(18679.14);
   ...
   Double_t Graph_fy105[4] = { 18679.14, 627.0102, 3.330223, 1.758e-05 };
   ...
   TH1F *Graph_Graph105 = new TH1F("Graph_Graph105","",100,0.0002997,0.366633);
   Graph_Graph105->SetMinimum(1.5822e-05);
   Graph_Graph105->SetMaximum(20547.05);
