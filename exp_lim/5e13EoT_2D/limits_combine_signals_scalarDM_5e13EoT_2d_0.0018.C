...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_0.0018()
{
...
//=========  (Mon Mar  2 03:15:02 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx309[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph0_fy309[4] = { 22015, 1547.5, 182.5, 25.54688 };
   TGraph *graph = new TGraph(4,Graph0_fx309,Graph0_fy309);
   ...
   TH1F *Graph_Graph0309 = new TH1F("Graph_Graph0309","",100,0,0.366633);
   ...
   Graph_Graph0309->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0309->GetXaxis()->SetRange(1,100);
   ...
   Graph_Graph0309->GetYaxis()->SetTitle("N_{sig}");
   ...
   Double_t Graph1_fx310[10] = { 0.000333, 0.003333, 0.033333, 0.333333, 0.333333, 0.333333, 0.333333, 0.033333, 0.003333, 0.000333 };
   Double_t Graph1_fy310[10] = { 25963.95, 4705.702, 251.1274, 40.66906, 40.66906, 19.16016, 19.16016, 134.7363, 846.2891, 10921.5 };
   graph = new TGraph(10,Graph1_fx310,Graph1_fy310);
   ...
   TH1F *Graph_Graph1310 = new TH1F("Graph_Graph1310","Graph",100,0,0.366633);
   Graph_Graph1310->SetMinimum(17.24414);
   Graph_Graph1310->SetMaximum(28558.43);
   ...
   Double_t Graph2_fx311[10] = { 0.000333, 0.003333, 0.033333, 0.333333, 0.333333, 0.333333, 0.333333, 0.033333, 0.003333, 0.000333 };
   Double_t Graph2_fy311[10] = { 22015.09, 2139.667, 212.6893, 31.96222, 31.96222, 21.55518, 21.55518, 157.1255, 1120.2, 20454.98 };
   graph = new TGraph(10,Graph2_fx311,Graph2_fy311);
   ...
   TH1F *Graph_Graph2311 = new TH1F("Graph_Graph2311","Graph",100,0,0.366633);
   Graph_Graph2311->SetMinimum(19.39966);
   Graph_Graph2311->SetMaximum(24214.44);
   ...
   Double_t Graph0_fx312[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph0_fy312[4] = { 22015, 1547.5, 182.5, 25.54688 };
   graph = new TGraph(4,Graph0_fx312,Graph0_fy312);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0312 = new TH1F("Graph_Graph0312","",100,0,0.366633);
   ...
   Graph_Graph0312->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0312->GetXaxis()->SetRange(1,100);
   ...
   Graph_Graph0312->GetYaxis()->SetTitle("N_{sig}");
   ...
   Double_t Graph_fx313[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph_fy313[4] = { 325600.4, 10942.46, 58.09199, 0.003060382 };
   graph = new TGraph(4,Graph_fx313,Graph_fy313);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph313 = new TH1F("Graph_Graph313","",100,0,0.366633);
   Graph_Graph313->SetMinimum(0.002754344);
   Graph_Graph313->SetMaximum(358160.4);
   ...
   Double_t Graph_fx315[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph_fy315[4] = { 358160.4, 12036.71, 63.90119, 0.00336642 };
   graph = new TGraph(4,Graph_fx315,Graph_fy315);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph315 = new TH1F("Graph_Graph315","",100,0,0.366633);
   Graph_Graph315->SetMinimum(0.003029778);
   Graph_Graph315->SetMaximum(393976.5);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(0.02225766,0,0.02225766,401.787);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(0.01725766,0,"  0.02 TeV");
