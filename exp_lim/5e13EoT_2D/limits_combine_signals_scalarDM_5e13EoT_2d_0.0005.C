...
//=========  (Mon Mar  2 03:15:02 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy218[4] = { 22015, 1547.5, 182.5, 25.54688 };
   ...
   TH1F *Graph_Graph0218 = new TH1F("Graph_Graph0218","",100,0,0.366633);
   ...
   Graph_Graph0218->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0218->GetXaxis()->SetRange(1,100);
   ...
   Double_t Graph1_fy219[10] = { 25963.95, 4705.702, 251.1274, 40.66906, 40.66906, 19.16016, 19.16016, 134.7363, 846.2891, 10921.5 };
   ...
   TH1F *Graph_Graph1219 = new TH1F("Graph_Graph1219","Graph",100,0,0.366633);
   Graph_Graph1219->SetMinimum(17.24414);
   Graph_Graph1219->SetMaximum(28558.43);
   ...
   Double_t Graph2_fy220[10] = { 22015.09, 2139.667, 212.6893, 31.96222, 31.96222, 21.55518, 21.55518, 157.1255, 1120.2, 20454.98 };
   ...
   TH1F *Graph_Graph2220 = new TH1F("Graph_Graph2220","Graph",100,0,0.366633);
   Graph_Graph2220->SetMinimum(19.39966);
   Graph_Graph2220->SetMaximum(24214.44);
   ...
   Double_t Graph0_fy221[4] = { 22015, 1547.5, 182.5, 25.54688 };
   ...
   TH1F *Graph_Graph0221 = new TH1F("Graph_Graph0221","",100,0,0.366633);
   ...
   Graph_Graph0221->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0221->GetXaxis()->SetRange(1,100);
   ...
   Double_t Graph_fy222[4] = { 90444.56, 3039.574, 16.13667, 0.0008501062 };
   ...
   TH1F *Graph_Graph222 = new TH1F("Graph_Graph222","",100,0,0.366633);
   Graph_Graph222->SetMinimum(0.0007650956);
   Graph_Graph222->SetMaximum(99489.01);
   ...
   Double_t Graph_fy224[4] = { 99489.01, 3343.531, 17.75033, 0.0009351168 };
   ...
   TH1F *Graph_Graph224 = new TH1F("Graph_Graph224","",100,0,0.366633);
   Graph_Graph224->SetMinimum(0.0008416051);
   Graph_Graph224->SetMaximum(109437.9);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(0.009864455,0,0.009864455,971.6524);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(0.004864455,0,"  0.01 TeV");
