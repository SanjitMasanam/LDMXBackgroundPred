...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_1.8e-05()
{
...
//=========  (Mon Mar  2 03:15:02 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy57[4] = { 22015, 1547.5, 182.5, 25.54688 };
   ...
   TH1F *Graph_Graph057 = new TH1F("Graph_Graph057","",100,0,0.366633);
   ...
   Graph_Graph057->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph057->GetXaxis()->SetRange(1,100);
   ...
   Double_t Graph1_fy58[10] = { 25963.95, 4705.702, 251.1274, 40.66906, 40.66906, 19.16016, 19.16016, 134.7363, 846.2891, 10921.5 };
   ...
   TH1F *Graph_Graph158 = new TH1F("Graph_Graph158","Graph",100,0,0.366633);
   Graph_Graph158->SetMinimum(17.24414);
   ...
   Double_t Graph2_fy59[10] = { 22015.09, 2139.667, 212.6893, 31.96222, 31.96222, 21.55518, 21.55518, 157.1255, 1120.2, 20454.98 };
   ...
   TH1F *Graph_Graph259 = new TH1F("Graph_Graph259","Graph",100,0,0.366633);
   Graph_Graph259->SetMinimum(19.39966);
   ...
   Double_t Graph0_fy60[4] = { 22015, 1547.5, 182.5, 25.54688 };
   ...
   TH1F *Graph_Graph060 = new TH1F("Graph_Graph060","",100,0,0.366633);
   ...
   Graph_Graph060->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph060->GetXaxis()->SetRange(1,100);
   ...
   Double_t Graph_fy61[4] = { 3256.004, 109.4246, 0.5809199, 3.060382e-05 };
   ...
   TH1F *Graph_Graph61 = new TH1F("Graph_Graph61","",100,0,0.366633);
   Graph_Graph61->SetMinimum(2.754344e-05);
   Graph_Graph61->SetMaximum(3581.604);
   ...
   Double_t Graph_fy63[4] = { 3581.604, 120.3671, 0.6390119, 3.36642e-05 };
   ...
   TH1F *Graph_Graph63 = new TH1F("Graph_Graph63","",100,0,0.366633);
   Graph_Graph63->SetMinimum(3.029778e-05);
   Graph_Graph63->SetMaximum(3939.765);
