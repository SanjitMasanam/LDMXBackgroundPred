...
//=========  (Mon Mar  2 03:15:02 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy197[4] = { 22015, 1547.5, 182.5, 25.54688 };
   ...
   TH1F *Graph_Graph0197 = new TH1F("Graph_Graph0197","",100,0,0.366633);
   ...
   Graph_Graph0197->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0197->GetXaxis()->SetRange(1,100);
   ...
   Double_t Graph1_fy198[10] = { 25963.95, 4705.702, 251.1274, 40.66906, 40.66906, 19.16016, 19.16016, 134.7363, 846.2891, 10921.5 };
   ...
   TH1F *Graph_Graph1198 = new TH1F("Graph_Graph1198","Graph",100,0,0.366633);
   Graph_Graph1198->SetMinimum(17.24414);
   Graph_Graph1198->SetMaximum(28558.43);
   ...
   Double_t Graph2_fy199[10] = { 22015.09, 2139.667, 212.6893, 31.96222, 31.96222, 21.55518, 21.55518, 157.1255, 1120.2, 20454.98 };
   ...
   TH1F *Graph_Graph2199 = new TH1F("Graph_Graph2199","Graph",100,0,0.366633);
   Graph_Graph2199->SetMinimum(19.39966);
   Graph_Graph2199->SetMaximum(24214.44);
   ...
   Double_t Graph0_fy200[4] = { 22015, 1547.5, 182.5, 25.54688 };
   ...
   TH1F *Graph_Graph0200 = new TH1F("Graph_Graph0200","",100,0,0.366633);
   ...
   Graph_Graph0200->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0200->GetXaxis()->SetRange(1,100);
   ...
   Double_t Graph_fy201[4] = { 36177.82, 1215.829, 6.454666, 0.0003400425 };
   ...
   TH1F *Graph_Graph201 = new TH1F("Graph_Graph201","",100,0,0.366633);
   Graph_Graph201->SetMinimum(0.0003060382);
   Graph_Graph201->SetMaximum(39795.6);
   ...
   Double_t Graph_fy203[4] = { 39795.6, 1337.412, 7.100133, 0.0003740467 };
   ...
   TH1F *Graph_Graph203 = new TH1F("Graph_Graph203","",100,0,0.366633);
   Graph_Graph203->SetMinimum(0.000336642);
   Graph_Graph203->SetMaximum(43775.16);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(0.00235237,0,0.00235237,3685.94);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(-0.00264763,0,"  0.00 TeV");
