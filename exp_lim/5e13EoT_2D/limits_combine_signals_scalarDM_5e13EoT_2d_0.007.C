...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_0.007()
{
...
//=========  (Mon Mar  2 03:15:02 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx358[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph0_fy358[4] = { 22015, 1547.5, 182.5, 25.54688 };
   TGraph *graph = new TGraph(4,Graph0_fx358,Graph0_fy358);
   ...
   TH1F *Graph_Graph0358 = new TH1F("Graph_Graph0358","",100,0,0.366633);
   ...
   Graph_Graph0358->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0358->GetXaxis()->SetRange(1,100);
   ...
   Graph_Graph0358->GetYaxis()->SetTitle("N_{sig}");
   ...
   Double_t Graph1_fx359[10] = { 0.000333, 0.003333, 0.033333, 0.333333, 0.333333, 0.333333, 0.333333, 0.033333, 0.003333, 0.000333 };
   Double_t Graph1_fy359[10] = { 25963.95, 4705.702, 251.1274, 40.66906, 40.66906, 19.16016, 19.16016, 134.7363, 846.2891, 10921.5 };
   graph = new TGraph(10,Graph1_fx359,Graph1_fy359);
   ...
   TH1F *Graph_Graph1359 = new TH1F("Graph_Graph1359","Graph",100,0,0.366633);
   Graph_Graph1359->SetMinimum(17.24414);
   Graph_Graph1359->SetMaximum(28558.43);
   ...
   Double_t Graph2_fx360[10] = { 0.000333, 0.003333, 0.033333, 0.333333, 0.333333, 0.333333, 0.333333, 0.033333, 0.003333, 0.000333 };
   Double_t Graph2_fy360[10] = { 22015.09, 2139.667, 212.6893, 31.96222, 31.96222, 21.55518, 21.55518, 157.1255, 1120.2, 20454.98 };
   graph = new TGraph(10,Graph2_fx360,Graph2_fy360);
   ...
   TH1F *Graph_Graph2360 = new TH1F("Graph_Graph2360","Graph",100,0,0.366633);
   Graph_Graph2360->SetMinimum(19.39966);
   Graph_Graph2360->SetMaximum(24214.44);
   ...
   Double_t Graph0_fx361[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph0_fy361[4] = { 22015, 1547.5, 182.5, 25.54688 };
   graph = new TGraph(4,Graph0_fx361,Graph0_fy361);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0361 = new TH1F("Graph_Graph0361","",100,0,0.366633);
   ...
   Graph_Graph0361->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0361->GetXaxis()->SetRange(1,100);
   ...
   Graph_Graph0361->GetYaxis()->SetTitle("N_{sig}");
   ...
   Double_t Graph_fx362[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph_fy362[4] = { 1266224, 42554.03, 225.9133, 0.01190149 };
   graph = new TGraph(4,Graph_fx362,Graph_fy362);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph362 = new TH1F("Graph_Graph362","",100,0,0.366633);
   Graph_Graph362->SetMinimum(0.01071134);
   Graph_Graph362->SetMaximum(1392846);
   ...
   Double_t Graph_fx364[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph_fy364[4] = { 1392846, 46809.43, 248.5046, 0.01309164 };
   graph = new TGraph(4,Graph_fx364,Graph_fy364);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph364 = new TH1F("Graph_Graph364","",100,0,0.366633);
   Graph_Graph364->SetMinimum(0.01178247);
   Graph_Graph364->SetMaximum(1532131);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(0.04145225,0,0.04145225,173.0422);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(0.03645225,0,"  0.04 TeV");
