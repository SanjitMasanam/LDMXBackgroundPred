...
//=========  (Tue Feb 24 10:30:56 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy232[4] = { 22015, 1525, 185.1562, 26.17188 };
   ...
   TH1F *Graph_Graph0232 = new TH1F("Graph_Graph0232","",100,0.0002997,0.366633);
   ...
   Graph_Graph0232->GetXaxis()->SetTitle("m(#chi) [GeV]");
   Graph_Graph0232->GetXaxis()->SetRange(0,101);
   ...
   Double_t Graph1_fy233[10] = { 25974.92, 4637.283, 253.7817, 41.44204, 41.44204, 19.73114, 19.73114, 138.8672, 833.9844, 10663.52 };
   ...
   TH1F *Graph_Graph1233 = new TH1F("Graph_Graph1233","Graph",100,0.0002997,0.366633);
   Graph_Graph1233->SetMinimum(17.75803);
   Graph_Graph1233->SetMaximum(28570.44);
   ...
   Double_t Graph2_fy234[10] = { 22015.09, 2111.596, 215.2314, 32.63985, 32.63985, 22.0961, 22.0961, 161.2885, 1109.311, 20374.36 };
   ...
   TH1F *Graph_Graph2234 = new TH1F("Graph_Graph2234","Graph",100,0.0002997,0.366633);
   Graph_Graph2234->SetMinimum(19.88649);
   Graph_Graph2234->SetMaximum(24214.38);
   ...
   Double_t Graph0_fy235[4] = { 22015, 1525, 185.1562, 26.17188 };
   ...
   TH1F *Graph_Graph0235 = new TH1F("Graph_Graph0235","",100,0.0002997,0.366633);
   ...
   Graph_Graph0235->GetXaxis()->SetTitle("m(#chi) [GeV]");
   Graph_Graph0235->GetXaxis()->SetRange(0,101);
   ...
   Double_t Graph_fy236[4] = { 3.396207e+08, 1.140018e+07, 60549.51, 0.3196363 };
   ...
   TH1F *Graph_Graph236 = new TH1F("Graph_Graph236","",100,0.0002997,0.366633);
   Graph_Graph236->SetMinimum(0.2876727);
   Graph_Graph236->SetMaximum(3.735828e+08);
   ...
   Double_t Graph_fy238[4] = { 3.735828e+08, 1.25402e+07, 66604.46, 0.3515999 };
   ...
   TH1F *Graph_Graph238 = new TH1F("Graph_Graph238","",100,0.0002997,0.366633);
   Graph_Graph238->SetMinimum(0.3164399);
   Graph_Graph238->SetMaximum(4.109411e+08);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(0.2037066,0,0.2037066,60.95112);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(0.1987066,0,"  0.20 GeV");
