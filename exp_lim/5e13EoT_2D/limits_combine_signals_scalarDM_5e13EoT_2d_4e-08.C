...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_4e-08()
{
...
//=========  (Tue Feb 24 10:30:55 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy50[4] = { 22015, 1525, 185.1562, 26.17188 };
   ...
   TH1F *Graph_Graph050 = new TH1F("Graph_Graph050","",100,0.0002997,0.366633);
   ...
   Double_t Graph1_fy51[10] = { 25974.92, 4637.283, 253.7817, 41.44204, 41.44204, 19.73114, 19.73114, 138.8672, 833.9844, 10663.52 };
   ...
   TH1F *Graph_Graph151 = new TH1F("Graph_Graph151","Graph",100,0.0002997,0.366633);
   Graph_Graph151->SetMinimum(17.75803);
   Graph_Graph151->SetMaximum(28570.44);
   ...
   Double_t Graph2_fy52[10] = { 22015.09, 2111.596, 215.2314, 32.63985, 32.63985, 22.0961, 22.0961, 161.2885, 1109.311, 20374.36 };
   ...
   TH1F *Graph_Graph252 = new TH1F("Graph_Graph252","Graph",100,0.0002997,0.366633);
   Graph_Graph252->SetMinimum(19.88649);
   Graph_Graph252->SetMaximum(24214.38);
   ...
   Double_t Graph0_fy53[4] = { 22015, 1525, 185.1562, 26.17188 };
   ...
   TH1F *Graph_Graph053 = new TH1F("Graph_Graph053","",100,0.0002997,0.366633);
   ...
   Double_t Graph_fy54[4] = { 679.2415, 22.80037, 0.121099, 6.392726e-07 };
   ...
   TH1F *Graph_Graph54 = new TH1F("Graph_Graph54","",100,0.0002997,0.366633);
   Graph_Graph54->SetMinimum(5.753453e-07);
   Graph_Graph54->SetMaximum(747.1656);
   ...
   Double_t Graph_fy56[4] = { 747.1656, 25.08041, 0.1332089, 7.031998e-07 };
   ...
   TH1F *Graph_Graph56 = new TH1F("Graph_Graph56","",100,0.0002997,0.366633);
   Graph_Graph56->SetMinimum(6.328798e-07);
   Graph_Graph56->SetMaximum(821.8822);
