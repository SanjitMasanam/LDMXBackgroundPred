...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_1.4e-05()
{
...
//=========  (Mon Mar  2 03:15:02 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy29[4] = { 22015, 1547.5, 182.5, 25.54688 };
   ...
   TH1F *Graph_Graph029 = new TH1F("Graph_Graph029","",100,0,0.366633);
   ...
   Graph_Graph029->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph029->GetXaxis()->SetRange(1,100);
   ...
   Double_t Graph1_fy30[10] = { 25963.95, 4705.702, 251.1274, 40.66906, 40.66906, 19.16016, 19.16016, 134.7363, 846.2891, 10921.5 };
   ...
   TH1F *Graph_Graph130 = new TH1F("Graph_Graph130","Graph",100,0,0.366633);
   Graph_Graph130->SetMinimum(17.24414);
   Graph_Graph130->SetMaximum(28558.43);
   ...
   Double_t Graph2_fy31[10] = { 22015.09, 2139.667, 212.6893, 31.96222, 31.96222, 21.55518, 21.55518, 157.1255, 1120.2, 20454.98 };
   ...
   TH1F *Graph_Graph231 = new TH1F("Graph_Graph231","Graph",100,0,0.366633);
   Graph_Graph231->SetMinimum(19.39966);
   Graph_Graph231->SetMaximum(24214.44);
   ...
   Double_t Graph0_fy32[4] = { 22015, 1547.5, 182.5, 25.54688 };
   ...
   TH1F *Graph_Graph032 = new TH1F("Graph_Graph032","",100,0,0.366633);
   ...
   Graph_Graph032->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph032->GetXaxis()->SetRange(1,100);
   ...
   Double_t Graph_fy33[4] = { 2532.448, 85.10806, 0.4518266, 2.380297e-05 };
   ...
   TH1F *Graph_Graph33 = new TH1F("Graph_Graph33","",100,0,0.366633);
   Graph_Graph33->SetMinimum(2.142268e-05);
   Graph_Graph33->SetMaximum(2785.692);
   ...
   Double_t Graph_fy35[4] = { 2785.692, 93.61887, 0.4970093, 2.618327e-05 };
   ...
   TH1F *Graph_Graph35 = new TH1F("Graph_Graph35","",100,0,0.366633);
   Graph_Graph35->SetMinimum(2.356494e-05);
   Graph_Graph35->SetMaximum(3064.262);
