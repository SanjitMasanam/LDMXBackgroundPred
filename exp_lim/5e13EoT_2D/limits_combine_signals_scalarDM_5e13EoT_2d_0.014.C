...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_0.014()
{
...
//=========  (Mon Mar  2 03:15:03 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx407[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph0_fy407[4] = { 22015, 1547.5, 182.5, 25.54688 };
   TGraph *graph = new TGraph(4,Graph0_fx407,Graph0_fy407);
   ...
   TH1F *Graph_Graph0407 = new TH1F("Graph_Graph0407","",100,0,0.366633);
   ...
   Graph_Graph0407->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0407->GetXaxis()->SetRange(1,100);
   ...
   Graph_Graph0407->GetYaxis()->SetTitle("N_{sig}");
   ...
   Double_t Graph1_fx408[10] = { 0.000333, 0.003333, 0.033333, 0.333333, 0.333333, 0.333333, 0.333333, 0.033333, 0.003333, 0.000333 };
   Double_t Graph1_fy408[10] = { 25963.95, 4705.702, 251.1274, 40.66906, 40.66906, 19.16016, 19.16016, 134.7363, 846.2891, 10921.5 };
   graph = new TGraph(10,Graph1_fx408,Graph1_fy408);
   ...
   TH1F *Graph_Graph1408 = new TH1F("Graph_Graph1408","Graph",100,0,0.366633);
   Graph_Graph1408->SetMinimum(17.24414);
   Graph_Graph1408->SetMaximum(28558.43);
   ...
   Double_t Graph2_fx409[10] = { 0.000333, 0.003333, 0.033333, 0.333333, 0.333333, 0.333333, 0.333333, 0.033333, 0.003333, 0.000333 };
   Double_t Graph2_fy409[10] = { 22015.09, 2139.667, 212.6893, 31.96222, 31.96222, 21.55518, 21.55518, 157.1255, 1120.2, 20454.98 };
   graph = new TGraph(10,Graph2_fx409,Graph2_fy409);
   ...
   TH1F *Graph_Graph2409 = new TH1F("Graph_Graph2409","Graph",100,0,0.366633);
   Graph_Graph2409->SetMinimum(19.39966);
   Graph_Graph2409->SetMaximum(24214.44);
   ...
   Double_t Graph0_fx410[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph0_fy410[4] = { 22015, 1547.5, 182.5, 25.54688 };
   graph = new TGraph(4,Graph0_fx410,Graph0_fy410);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0410 = new TH1F("Graph_Graph0410","",100,0,0.366633);
   ...
   Graph_Graph0410->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0410->GetXaxis()->SetRange(1,100);
   ...
   Graph_Graph0410->GetYaxis()->SetTitle("N_{sig}");
   ...
   Double_t Graph_fx411[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph_fy411[4] = { 2532448, 85108.06, 451.8266, 0.02380297 };
   graph = new TGraph(4,Graph_fx411,Graph_fy411);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph411 = new TH1F("Graph_Graph411","",100,0,0.366633);
   Graph_Graph411->SetMinimum(0.02142268);
   Graph_Graph411->SetMaximum(2785692);
   ...
   Double_t Graph_fx413[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph_fy413[4] = { 2785692, 93618.87, 497.0093, 0.02618327 };
   graph = new TGraph(4,Graph_fx413,Graph_fy413);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph413 = new TH1F("Graph_Graph413","",100,0,0.366633);
   Graph_Graph413->SetMinimum(0.02356494);
   Graph_Graph413->SetMaximum(3064262);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(0.06782434,0,0.06782434,145.5748);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(0.06282434,0,"  0.07 TeV");
