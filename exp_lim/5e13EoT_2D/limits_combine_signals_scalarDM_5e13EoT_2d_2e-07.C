...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_2e-07()
{
...
//=========  (Tue Feb 24 10:30:55 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy78[4] = { 22015, 1525, 185.1562, 26.17188 };
   ...
   TH1F *Graph_Graph078 = new TH1F("Graph_Graph078","",100,0.0002997,0.366633);
   ...
   Graph_Graph078->GetXaxis()->SetTitle("m(#chi) [GeV]");
   Graph_Graph078->GetXaxis()->SetRange(0,101);
   ...
   Double_t Graph1_fy79[10] = { 25974.92, 4637.283, 253.7817, 41.44204, 41.44204, 19.73114, 19.73114, 138.8672, 833.9844, 10663.52 };
   ...
   TH1F *Graph_Graph179 = new TH1F("Graph_Graph179","Graph",100,0.0002997,0.366633);
   Graph_Graph179->SetMinimum(17.75803);
   Graph_Graph179->SetMaximum(28570.44);
   ...
   Double_t Graph2_fy80[10] = { 22015.09, 2111.596, 215.2314, 32.63985, 32.63985, 22.0961, 22.0961, 161.2885, 1109.311, 20374.36 };
   ...
   TH1F *Graph_Graph280 = new TH1F("Graph_Graph280","Graph",100,0.0002997,0.366633);
   Graph_Graph280->SetMinimum(19.88649);
   Graph_Graph280->SetMaximum(24214.38);
   ...
   Double_t Graph0_fy81[4] = { 22015, 1525, 185.1562, 26.17188 };
   ...
   TH1F *Graph_Graph081 = new TH1F("Graph_Graph081","",100,0.0002997,0.366633);
   ...
   Graph_Graph081->GetXaxis()->SetTitle("m(#chi) [GeV]");
   Graph_Graph081->GetXaxis()->SetRange(0,101);
   ...
   Double_t Graph_fy82[4] = { 3396.207, 114.0018, 0.6054951, 3.196363e-06 };
   ...
   TH1F *Graph_Graph82 = new TH1F("Graph_Graph82","",100,0.0002997,0.366633);
   Graph_Graph82->SetMinimum(2.876727e-06);
   Graph_Graph82->SetMaximum(3735.828);
   ...
   Double_t Graph_fy84[4] = { 3735.828, 125.402, 0.6660446, 3.515999e-06 };
   ...
   TH1F *Graph_Graph84 = new TH1F("Graph_Graph84","",100,0.0002997,0.366633);
   Graph_Graph84->SetMinimum(3.164399e-06);
   Graph_Graph84->SetMaximum(4109.411);
