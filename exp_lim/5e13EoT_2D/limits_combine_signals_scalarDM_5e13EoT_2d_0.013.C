...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_0.013()
{
...
//=========  (Mon Mar  2 03:15:03 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx400[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph0_fy400[4] = { 22015, 1547.5, 182.5, 25.54688 };
   TGraph *graph = new TGraph(4,Graph0_fx400,Graph0_fy400);
   ...
   TH1F *Graph_Graph0400 = new TH1F("Graph_Graph0400","",100,0,0.366633);
   ...
   Graph_Graph0400->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0400->GetXaxis()->SetRange(1,100);
   ...
   Graph_Graph0400->GetYaxis()->SetTitle("N_{sig}");
   ...
   Double_t Graph1_fx401[10] = { 0.000333, 0.003333, 0.033333, 0.333333, 0.333333, 0.333333, 0.333333, 0.033333, 0.003333, 0.000333 };
   Double_t Graph1_fy401[10] = { 25963.95, 4705.702, 251.1274, 40.66906, 40.66906, 19.16016, 19.16016, 134.7363, 846.2891, 10921.5 };
   graph = new TGraph(10,Graph1_fx401,Graph1_fy401);
   ...
   TH1F *Graph_Graph1401 = new TH1F("Graph_Graph1401","Graph",100,0,0.366633);
   Graph_Graph1401->SetMinimum(17.24414);
   Graph_Graph1401->SetMaximum(28558.43);
   ...
   Double_t Graph2_fx402[10] = { 0.000333, 0.003333, 0.033333, 0.333333, 0.333333, 0.333333, 0.333333, 0.033333, 0.003333, 0.000333 };
   Double_t Graph2_fy402[10] = { 22015.09, 2139.667, 212.6893, 31.96222, 31.96222, 21.55518, 21.55518, 157.1255, 1120.2, 20454.98 };
   graph = new TGraph(10,Graph2_fx402,Graph2_fy402);
   ...
   TH1F *Graph_Graph2402 = new TH1F("Graph_Graph2402","Graph",100,0,0.366633);
   Graph_Graph2402->SetMinimum(19.39966);
   Graph_Graph2402->SetMaximum(24214.44);
   ...
   Double_t Graph0_fx403[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph0_fy403[4] = { 22015, 1547.5, 182.5, 25.54688 };
   graph = new TGraph(4,Graph0_fx403,Graph0_fy403);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0403 = new TH1F("Graph_Graph0403","",100,0,0.366633);
   ...
   Graph_Graph0403->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0403->GetXaxis()->SetRange(1,100);
   ...
   Graph_Graph0403->GetYaxis()->SetTitle("N_{sig}");
   ...
   Double_t Graph_fx404[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph_fy404[4] = { 2351558, 79028.91, 419.5533, 0.02210276 };
   graph = new TGraph(4,Graph_fx404,Graph_fy404);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph404 = new TH1F("Graph_Graph404","",100,0,0.366633);
   Graph_Graph404->SetMinimum(0.01989248);
   Graph_Graph404->SetMaximum(2586714);
   ...
   Double_t Graph_fx406[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph_fy406[4] = { 2586714, 86931.8, 461.5086, 0.02431304 };
   graph = new TGraph(4,Graph_fx406,Graph_fy406);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph406 = new TH1F("Graph_Graph406","",100,0,0.366633);
   Graph_Graph406->SetMinimum(0.02188173);
   Graph_Graph406->SetMaximum(2845386);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(0.06500476,0,0.06500476,148.29);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(0.06000476,0,"  0.07 TeV");
