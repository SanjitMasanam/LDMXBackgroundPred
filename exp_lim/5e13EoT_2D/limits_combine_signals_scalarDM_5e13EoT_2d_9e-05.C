...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_9e-05()
{
...
//=========  (Mon Mar  2 03:15:02 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy120[4] = { 22015, 1547.5, 182.5, 25.54688 };
   ...
   TH1F *Graph_Graph0120 = new TH1F("Graph_Graph0120","",100,0,0.366633);
   ...
   Graph_Graph0120->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0120->GetXaxis()->SetRange(1,100);
   ...
   Double_t Graph1_fy121[10] = { 25963.95, 4705.702, 251.1274, 40.66906, 40.66906, 19.16016, 19.16016, 134.7363, 846.2891, 10921.5 };
   ...
   TH1F *Graph_Graph1121 = new TH1F("Graph_Graph1121","Graph",100,0,0.366633);
   Graph_Graph1121->SetMinimum(17.24414);
   Graph_Graph1121->SetMaximum(28558.43);
   ...
   Double_t Graph2_fy122[10] = { 22015.09, 2139.667, 212.6893, 31.96222, 31.96222, 21.55518, 21.55518, 157.1255, 1120.2, 20454.98 };
   ...
   TH1F *Graph_Graph2122 = new TH1F("Graph_Graph2122","Graph",100,0,0.366633);
   Graph_Graph2122->SetMinimum(19.39966);
   Graph_Graph2122->SetMaximum(24214.44);
   ...
   Double_t Graph0_fy123[4] = { 22015, 1547.5, 182.5, 25.54688 };
   ...
   TH1F *Graph_Graph0123 = new TH1F("Graph_Graph0123","",100,0,0.366633);
   ...
   Graph_Graph0123->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0123->GetXaxis()->SetRange(1,100);
   ...
   Double_t Graph_fy124[4] = { 16280.02, 547.1232, 2.9046, 0.0001530191 };
   ...
   TH1F *Graph_Graph124 = new TH1F("Graph_Graph124","",100,0,0.366633);
   Graph_Graph124->SetMinimum(0.0001377172);
   Graph_Graph124->SetMaximum(17908.02);
   ...
   Double_t Graph_fy126[4] = { 17908.02, 601.8356, 3.19506, 0.000168321 };
   ...
   TH1F *Graph_Graph126 = new TH1F("Graph_Graph126","",100,0,0.366633);
   Graph_Graph126->SetMinimum(0.0001514889);
   Graph_Graph126->SetMaximum(19698.82);
