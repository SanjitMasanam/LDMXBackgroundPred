...
//=========  (Tue Feb 24 10:30:56 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy190[4] = { 22015, 1525, 185.1562, 26.17188 };
   ...
   TH1F *Graph_Graph0190 = new TH1F("Graph_Graph0190","",100,0.0002997,0.366633);
   ...
   Graph_Graph0190->GetXaxis()->SetTitle("m(#chi) [GeV]");
   Graph_Graph0190->GetXaxis()->SetRange(0,101);
   ...
   Double_t Graph1_fy191[10] = { 25974.92, 4637.283, 253.7817, 41.44204, 41.44204, 19.73114, 19.73114, 138.8672, 833.9844, 10663.52 };
   ...
   TH1F *Graph_Graph1191 = new TH1F("Graph_Graph1191","Graph",100,0.0002997,0.366633);
   Graph_Graph1191->SetMinimum(17.75803);
   Graph_Graph1191->SetMaximum(28570.44);
   ...
   Double_t Graph2_fy192[10] = { 22015.09, 2111.596, 215.2314, 32.63985, 32.63985, 22.0961, 22.0961, 161.2885, 1109.311, 20374.36 };
   ...
   TH1F *Graph_Graph2192 = new TH1F("Graph_Graph2192","Graph",100,0.0002997,0.366633);
   Graph_Graph2192->SetMinimum(19.88649);
   Graph_Graph2192->SetMaximum(24214.38);
   ...
   Double_t Graph0_fy193[4] = { 22015, 1525, 185.1562, 26.17188 };
   ...
   TH1F *Graph_Graph0193 = new TH1F("Graph_Graph0193","",100,0.0002997,0.366633);
   ...
   Graph_Graph0193->GetXaxis()->SetTitle("m(#chi) [GeV]");
   Graph_Graph0193->GetXaxis()->SetRange(0,101);
   ...
   Double_t Graph_fy194[4] = { 1.358483e+07, 456007.4, 2421.98, 0.01278545 };
   ...
   TH1F *Graph_Graph194 = new TH1F("Graph_Graph194","",100,0.0002997,0.366633);
   Graph_Graph194->SetMinimum(0.01150691);
   Graph_Graph194->SetMaximum(1.494331e+07);
   ...
   Double_t Graph_fy196[4] = { 1.494331e+07, 501608.1, 2664.178, 0.014064 };
   ...
   TH1F *Graph_Graph196 = new TH1F("Graph_Graph196","",100,0.0002997,0.366633);
   Graph_Graph196->SetMinimum(0.0126576);
   Graph_Graph196->SetMaximum(1.643764e+07);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(0.1089898,0,0.1089898,113.0452);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(0.1039898,0,"  0.11 GeV");
