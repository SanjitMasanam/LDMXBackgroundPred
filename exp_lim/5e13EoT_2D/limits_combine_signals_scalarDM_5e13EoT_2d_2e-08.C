...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_2e-08()
{
...
//=========  (Tue Feb 24 10:30:55 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx36[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph0_fy36[4] = { 22015, 1525, 185.1562, 26.17188 };
   ...
   TH1F *Graph_Graph036 = new TH1F("Graph_Graph036","",100,0.0002997,0.366633);
   ...
   Double_t Graph1_fx37[10] = { 0.000333, 0.003333, 0.033333, 0.333333, 0.333333, 0.333333, 0.333333, 0.033333, 0.003333, 0.000333 };
   Double_t Graph1_fy37[10] = { 25974.92, 4637.283, 253.7817, 41.44204, 41.44204, 19.73114, 19.73114, 138.8672, 833.9844, 10663.52 };
   ...
   TH1F *Graph_Graph137 = new TH1F("Graph_Graph137","Graph",100,0.0002997,0.366633);
   Graph_Graph137->SetMinimum(17.75803);
   Graph_Graph137->SetMaximum(28570.44);
   ...
   Double_t Graph2_fx38[10] = { 0.000333, 0.003333, 0.033333, 0.333333, 0.333333, 0.333333, 0.333333, 0.033333, 0.003333, 0.000333 };
   Double_t Graph2_fy38[10] = { 22015.09, 2111.596, 215.2314, 32.63985, 32.63985, 22.0961, 22.0961, 161.2885, 1109.311, 20374.36 };
   ...
   TH1F *Graph_Graph238 = new TH1F("Graph_Graph238","Graph",100,0.0002997,0.366633);
   Graph_Graph238->SetMinimum(19.88649);
   Graph_Graph238->SetMaximum(24214.38);
   ...
   Double_t Graph0_fx39[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph0_fy39[4] = { 22015, 1525, 185.1562, 26.17188 };
   ...
   TH1F *Graph_Graph039 = new TH1F("Graph_Graph039","",100,0.0002997,0.366633);
   ...
   Double_t Graph_fx40[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph_fy40[4] = { 339.6207, 11.40018, 0.06054951, 3.196363e-07 };
   ...
   TH1F *Graph_Graph40 = new TH1F("Graph_Graph40","",100,0.0002997,0.366633);
   Graph_Graph40->SetMinimum(2.876727e-07);
   Graph_Graph40->SetMaximum(373.5828);
   ...
   Double_t Graph_fx42[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph_fy42[4] = { 373.5828, 12.5402, 0.06660446, 3.515999e-07 };
   ...
   TH1F *Graph_Graph42 = new TH1F("Graph_Graph42","",100,0.0002997,0.366633);
   Graph_Graph42->SetMinimum(3.164399e-07);
   Graph_Graph42->SetMaximum(410.9411);
