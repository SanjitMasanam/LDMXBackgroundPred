...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_1.3e-05()
{
...
//=========  (Mon Mar  2 03:15:02 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy22[4] = { 22015, 1547.5, 182.5, 25.54688 };
   ...
   TH1F *Graph_Graph022 = new TH1F("Graph_Graph022","",100,0,0.366633);
   ...
   Graph_Graph022->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph022->GetXaxis()->SetRange(1,100);
   ...
   Double_t Graph1_fy23[10] = { 25963.95, 4705.702, 251.1274, 40.66906, 40.66906, 19.16016, 19.16016, 134.7363, 846.2891, 10921.5 };
   ...
   TH1F *Graph_Graph123 = new TH1F("Graph_Graph123","Graph",100,0,0.366633);
   Graph_Graph123->SetMinimum(17.24414);
   Graph_Graph123->SetMaximum(28558.43);
   ...
   Double_t Graph2_fy24[10] = { 22015.09, 2139.667, 212.6893, 31.96222, 31.96222, 21.55518, 21.55518, 157.1255, 1120.2, 20454.98 };
   ...
   TH1F *Graph_Graph224 = new TH1F("Graph_Graph224","Graph",100,0,0.366633);
   Graph_Graph224->SetMinimum(19.39966);
   Graph_Graph224->SetMaximum(24214.44);
   ...
   Double_t Graph0_fy25[4] = { 22015, 1547.5, 182.5, 25.54688 };
   ...
   TH1F *Graph_Graph025 = new TH1F("Graph_Graph025","",100,0,0.366633);
   ...
   Graph_Graph025->GetXaxis()->SetTitle("m(#chi) [MeV]");
   ...
   Double_t Graph_fy26[4] = { 2351.558, 79.02891, 0.4195533, 2.210276e-05 };
   ...
   TH1F *Graph_Graph26 = new TH1F("Graph_Graph26","",100,0,0.366633);
   Graph_Graph26->SetMinimum(1.989248e-05);
   Graph_Graph26->SetMaximum(2586.714);
   ...
   Double_t Graph_fy28[4] = { 2586.714, 86.9318, 0.4615086, 2.431304e-05 };
   ...
   TH1F *Graph_Graph28 = new TH1F("Graph_Graph28","",100,0,0.366633);
   Graph_Graph28->SetMinimum(2.188173e-05);
   Graph_Graph28->SetMaximum(2845.386);
