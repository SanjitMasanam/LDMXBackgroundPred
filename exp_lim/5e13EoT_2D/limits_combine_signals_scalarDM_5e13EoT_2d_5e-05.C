...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_5e-05()
{
...
//=========  (Tue Feb 24 10:30:56 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy155[4] = { 22015, 1525, 185.1562, 26.17188 };
   ...
   TH1F *Graph_Graph0155 = new TH1F("Graph_Graph0155","",100,0.0002997,0.366633);
   ...
   Graph_Graph0155->GetXaxis()->SetTitle("m(#chi) [GeV]");
   Graph_Graph0155->GetXaxis()->SetRange(0,101);
   ...
   Double_t Graph1_fy156[10] = { 25974.92, 4637.283, 253.7817, 41.44204, 41.44204, 19.73114, 19.73114, 138.8672, 833.9844, 10663.52 };
   ...
   TH1F *Graph_Graph1156 = new TH1F("Graph_Graph1156","Graph",100,0.0002997,0.366633);
   Graph_Graph1156->SetMinimum(17.75803);
   Graph_Graph1156->SetMaximum(28570.44);
   ...
   Double_t Graph2_fy157[10] = { 22015.09, 2111.596, 215.2314, 32.63985, 32.63985, 22.0961, 22.0961, 161.2885, 1109.311, 20374.36 };
   ...
   TH1F *Graph_Graph2157 = new TH1F("Graph_Graph2157","Graph",100,0.0002997,0.366633);
   Graph_Graph2157->SetMinimum(19.88649);
   Graph_Graph2157->SetMaximum(24214.38);
   ...
   Double_t Graph0_fy158[4] = { 22015, 1525, 185.1562, 26.17188 };
   ...
   TH1F *Graph_Graph0158 = new TH1F("Graph_Graph0158","",100,0.0002997,0.366633);
   ...
   Graph_Graph0158->GetXaxis()->SetTitle("m(#chi) [GeV]");
   Graph_Graph0158->GetXaxis()->SetRange(0,101);
   ...
   Double_t Graph_fy159[4] = { 849051.9, 28500.46, 151.3738, 0.0007990907 };
   ...
   TH1F *Graph_Graph159 = new TH1F("Graph_Graph159","",100,0.0002997,0.366633);
   Graph_Graph159->SetMinimum(0.0007191816);
   Graph_Graph159->SetMaximum(933957);
   ...
   Double_t Graph_fy161[4] = { 933957, 31350.51, 166.5112, 0.0008789998 };
   ...
   TH1F *Graph_Graph161 = new TH1F("Graph_Graph161","",100,0.0002997,0.366633);
   Graph_Graph161->SetMinimum(0.0007910998);
   Graph_Graph161->SetMaximum(1027353);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(0.0314018,0,0.0314018,212.0738);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(0.0264018,0,"  0.03 GeV");
