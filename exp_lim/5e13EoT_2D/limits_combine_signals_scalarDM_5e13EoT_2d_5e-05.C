...
//=========  (Mon Mar  2 03:15:02 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy92[4] = { 22015, 1547.5, 182.5, 25.54688 };
   ...
   TH1F *Graph_Graph092 = new TH1F("Graph_Graph092","",100,0,0.366633);
   ...
   Graph_Graph092->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph092->GetXaxis()->SetRange(1,100);
   ...
   Double_t Graph1_fy93[10] = { 25963.95, 4705.702, 251.1274, 40.66906, 40.66906, 19.16016, 19.16016, 134.7363, 846.2891, 10921.5 };
   ...
   TH1F *Graph_Graph193 = new TH1F("Graph_Graph193","Graph",100,0,0.366633);
   Graph_Graph193->SetMinimum(17.24414);
   ...
   Double_t Graph2_fy94[10] = { 22015.09, 2139.667, 212.6893, 31.96222, 31.96222, 21.55518, 21.55518, 157.1255, 1120.2, 20454.98 };
   ...
   TH1F *Graph_Graph294 = new TH1F("Graph_Graph294","Graph",100,0,0.366633);
   Graph_Graph294->SetMinimum(19.39966);
   ...
   Double_t Graph0_fy95[4] = { 22015, 1547.5, 182.5, 25.54688 };
   ...
   TH1F *Graph_Graph095 = new TH1F("Graph_Graph095","",100,0,0.366633);
   ...
   Graph_Graph095->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph095->GetXaxis()->SetRange(1,100);
   ...
   Double_t Graph_fy96[4] = { 9044.456, 303.9574, 1.613667, 8.501062e-05 };
   ...
   TH1F *Graph_Graph96 = new TH1F("Graph_Graph96","",100,0,0.366633);
   Graph_Graph96->SetMinimum(7.650956e-05);
   Graph_Graph96->SetMaximum(9948.901);
   ...
   Double_t Graph_fy98[4] = { 9948.901, 334.3531, 1.775033, 9.351168e-05 };
   ...
   TH1F *Graph_Graph98 = new TH1F("Graph_Graph98","",100,0,0.366633);
   Graph_Graph98->SetMinimum(8.416051e-05);
   Graph_Graph98->SetMaximum(10943.79);
