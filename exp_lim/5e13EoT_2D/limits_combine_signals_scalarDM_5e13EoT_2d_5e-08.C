...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_5e-08()
{
...
//=========  (Tue Feb 24 10:30:55 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx57[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph0_fy57[4] = { 22015, 1525, 185.1562, 26.17188 };
   ...
   TH1F *Graph_Graph057 = new TH1F("Graph_Graph057","",100,0.0002997,0.366633);
   ...
   Double_t Graph1_fx58[10] = { 0.000333, 0.003333, 0.033333, 0.333333, 0.333333, 0.333333, 0.333333, 0.033333, 0.003333, 0.000333 };
   Double_t Graph1_fy58[10] = { 25974.92, 4637.283, 253.7817, 41.44204, 41.44204, 19.73114, 19.73114, 138.8672, 833.9844, 10663.52 };
   ...
   TH1F *Graph_Graph158 = new TH1F("Graph_Graph158","Graph",100,0.0002997,0.366633);
   Graph_Graph158->SetMinimum(17.75803);
   Graph_Graph158->SetMaximum(28570.44);
   ...
   Double_t Graph2_fx59[10] = { 0.000333, 0.003333, 0.033333, 0.333333, 0.333333, 0.333333, 0.333333, 0.033333, 0.003333, 0.000333 };
   Double_t Graph2_fy59[10] = { 22015.09, 2111.596, 215.2314, 32.63985, 32.63985, 22.0961, 22.0961, 161.2885, 1109.311, 20374.36 };
   ...
   TH1F *Graph_Graph259 = new TH1F("Graph_Graph259","Graph",100,0.0002997,0.366633);
   Graph_Graph259->SetMinimum(19.88649);
   Graph_Graph259->SetMaximum(24214.38);
   ...
   Double_t Graph0_fx60[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph0_fy60[4] = { 22015, 1525, 185.1562, 26.17188 };
   ...
   TH1F *Graph_Graph060 = new TH1F("Graph_Graph060","",100,0.0002997,0.366633);
   ...
   Double_t Graph_fx61[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph_fy61[4] = { 849.0519, 28.50046, 0.1513738, 7.990907e-07 };
   ...
   TH1F *Graph_Graph61 = new TH1F("Graph_Graph61","",100,0.0002997,0.366633);
   Graph_Graph61->SetMinimum(7.191816e-07);
   Graph_Graph61->SetMaximum(933.957);
   ...
   Double_t Graph_fx63[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph_fy63[4] = { 933.957, 31.35051, 0.1665112, 8.789998e-07 };
   ...
   TH1F *Graph_Graph63 = new TH1F("Graph_Graph63","",100,0.0002997,0.366633);
   Graph_Graph63->SetMinimum(7.910998e-07);
   Graph_Graph63->SetMaximum(1027.353);
