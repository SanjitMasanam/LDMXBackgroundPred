...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_1e-07()
{
...
//=========  (Tue Feb 24 10:30:55 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx71[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph0_fy71[4] = { 22015, 1525, 185.1562, 26.17188 };
   ...
   TH1F *Graph_Graph071 = new TH1F("Graph_Graph071","",100,0.0002997,0.366633);
   ...
   Double_t Graph1_fx72[10] = { 0.000333, 0.003333, 0.033333, 0.333333, 0.333333, 0.333333, 0.333333, 0.033333, 0.003333, 0.000333 };
   Double_t Graph1_fy72[10] = { 25974.92, 4637.283, 253.7817, 41.44204, 41.44204, 19.73114, 19.73114, 138.8672, 833.9844, 10663.52 };
   ...
   TH1F *Graph_Graph172 = new TH1F("Graph_Graph172","Graph",100,0.0002997,0.366633);
   Graph_Graph172->SetMinimum(17.75803);
   Graph_Graph172->SetMaximum(28570.44);
   ...
   Double_t Graph2_fx73[10] = { 0.000333, 0.003333, 0.033333, 0.333333, 0.333333, 0.333333, 0.333333, 0.033333, 0.003333, 0.000333 };
   Double_t Graph2_fy73[10] = { 22015.09, 2111.596, 215.2314, 32.63985, 32.63985, 22.0961, 22.0961, 161.2885, 1109.311, 20374.36 };
   ...
   TH1F *Graph_Graph273 = new TH1F("Graph_Graph273","Graph",100,0.0002997,0.366633);
   Graph_Graph273->SetMinimum(19.88649);
   Graph_Graph273->SetMaximum(24214.38);
   ...
   Double_t Graph0_fx74[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph0_fy74[4] = { 22015, 1525, 185.1562, 26.17188 };
   ...
   TH1F *Graph_Graph074 = new TH1F("Graph_Graph074","",100,0.0002997,0.366633);
   ...
   Double_t Graph_fx75[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph_fy75[4] = { 1698.104, 57.00092, 0.3027476, 1.598181e-06 };
   ...
   TH1F *Graph_Graph75 = new TH1F("Graph_Graph75","",100,0.0002997,0.366633);
   Graph_Graph75->SetMinimum(1.438363e-06);
   Graph_Graph75->SetMaximum(1867.914);
   ...
   Double_t Graph_fx77[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph_fy77[4] = { 1867.914, 62.70102, 0.3330223, 1.758e-06 };
   ...
   TH1F *Graph_Graph77 = new TH1F("Graph_Graph77","",100,0.0002997,0.366633);
   Graph_Graph77->SetMinimum(1.5822e-06);
   Graph_Graph77->SetMaximum(2054.705);
