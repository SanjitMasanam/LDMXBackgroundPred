...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_2e-09()
{
...
//=========  (Tue Feb 24 10:30:54 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy8[4] = { 22015, 1525, 185.1562, 26.17188 };
   ...
   TH1F *Graph_Graph08 = new TH1F("Graph_Graph08","",100,0.0002997,0.366633);
   ...
   Graph_Graph08->GetXaxis()->SetTitle("m(#chi) [GeV]");
   Graph_Graph08->GetXaxis()->SetRange(0,101);
   ...
   Double_t Graph1_fy9[10] = { 25974.92, 4637.283, 253.7817, 41.44204, 41.44204, 19.73114, 19.73114, 138.8672, 833.9844, 10663.52 };
   ...
   TH1F *Graph_Graph19 = new TH1F("Graph_Graph19","Graph",100,0.0002997,0.366633);
   Graph_Graph19->SetMinimum(17.75803);
   Graph_Graph19->SetMaximum(28570.44);
   ...
   Double_t Graph2_fy10[10] = { 22015.09, 2111.596, 215.2314, 32.63985, 32.63985, 22.0961, 22.0961, 161.2885, 1109.311, 20374.36 };
   ...
   TH1F *Graph_Graph210 = new TH1F("Graph_Graph210","Graph",100,0.0002997,0.366633);
   Graph_Graph210->SetMinimum(19.88649);
   Graph_Graph210->SetMaximum(24214.38);
   ...
   Double_t Graph0_fy11[4] = { 22015, 1525, 185.1562, 26.17188 };
   ...
   TH1F *Graph_Graph011 = new TH1F("Graph_Graph011","",100,0.0002997,0.366633);
   ...
   Graph_Graph011->GetXaxis()->SetTitle("m(#chi) [GeV]");
   Graph_Graph011->GetXaxis()->SetRange(0,101);
   ...
   Double_t Graph_fy12[4] = { 33.96207, 1.140018, 0.006054951, 3.196363e-08 };
   ...
   TH1F *Graph_Graph12 = new TH1F("Graph_Graph12","",100,0.0002997,0.366633);
   Graph_Graph12->SetMinimum(2.876727e-08);
   Graph_Graph12->SetMaximum(37.35828);
   ...
   Double_t Graph_fy14[4] = { 37.35828, 1.25402, 0.006660446, 3.515999e-08 };
   ...
   TH1F *Graph_Graph14 = new TH1F("Graph_Graph14","",100,0.0002997,0.366633);
   Graph_Graph14->SetMinimum(3.164399e-08);
   Graph_Graph14->SetMaximum(41.09411);
