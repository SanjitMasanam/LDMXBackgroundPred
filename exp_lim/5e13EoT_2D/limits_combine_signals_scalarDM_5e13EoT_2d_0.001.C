...
//=========  (Mon Mar  2 03:15:02 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy253[4] = { 22015, 1547.5, 182.5, 25.54688 };
   ...
   TH1F *Graph_Graph0253 = new TH1F("Graph_Graph0253","",100,0,0.366633);
   ...
   Graph_Graph0253->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0253->GetXaxis()->SetRange(1,100);
   ...
   Double_t Graph1_fy254[10] = { 25963.95, 4705.702, 251.1274, 40.66906, 40.66906, 19.16016, 19.16016, 134.7363, 846.2891, 10921.5 };
   ...
   TH1F *Graph_Graph1254 = new TH1F("Graph_Graph1254","Graph",100,0,0.366633);
   Graph_Graph1254->SetMinimum(17.24414);
   Graph_Graph1254->SetMaximum(28558.43);
   ...
   Double_t Graph2_fy255[10] = { 22015.09, 2139.667, 212.6893, 31.96222, 31.96222, 21.55518, 21.55518, 157.1255, 1120.2, 20454.98 };
   ...
   TH1F *Graph_Graph2255 = new TH1F("Graph_Graph2255","Graph",100,0,0.366633);
   Graph_Graph2255->SetMinimum(19.39966);
   Graph_Graph2255->SetMaximum(24214.44);
   ...
   Double_t Graph0_fy256[4] = { 22015, 1547.5, 182.5, 25.54688 };
   ...
   TH1F *Graph_Graph0256 = new TH1F("Graph_Graph0256","",100,0,0.366633);
   ...
   Graph_Graph0256->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0256->GetXaxis()->SetRange(1,100);
   ...
   Double_t Graph_fy257[4] = { 180889.1, 6079.147, 32.27333, 0.001700212 };
   ...
   TH1F *Graph_Graph257 = new TH1F("Graph_Graph257","",100,0,0.366633);
   Graph_Graph257->SetMinimum(0.001530191);
   Graph_Graph257->SetMaximum(198978);
   ...
   Double_t Graph_fy259[4] = { 198978, 6687.062, 35.50066, 0.001870234 };
   ...
   TH1F *Graph_Graph259 = new TH1F("Graph_Graph259","",100,0,0.366633);
   Graph_Graph259->SetMinimum(0.00168321);
   Graph_Graph259->SetMaximum(218875.8);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(0.01657075,0,0.01657075,602.5329);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(0.01157075,0,"  0.02 TeV");
