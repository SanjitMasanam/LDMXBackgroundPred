...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_1.5e-05()
{
...
//=========  (Mon Mar  2 03:15:02 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy36[4] = { 22015, 1547.5, 182.5, 25.54688 };
   ...
   TH1F *Graph_Graph036 = new TH1F("Graph_Graph036","",100,0,0.366633);
   ...
   Graph_Graph036->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph036->GetXaxis()->SetRange(1,100);
   ...
   Double_t Graph1_fy37[10] = { 25963.95, 4705.702, 251.1274, 40.66906, 40.66906, 19.16016, 19.16016, 134.7363, 846.2891, 10921.5 };
   ...
   TH1F *Graph_Graph137 = new TH1F("Graph_Graph137","Graph",100,0,0.366633);
   Graph_Graph137->SetMinimum(17.24414);
   ...
   Double_t Graph2_fy38[10] = { 22015.09, 2139.667, 212.6893, 31.96222, 31.96222, 21.55518, 21.55518, 157.1255, 1120.2, 20454.98 };
   ...
   TH1F *Graph_Graph238 = new TH1F("Graph_Graph238","Graph",100,0,0.366633);
   Graph_Graph238->SetMinimum(19.39966);
   ...
   Double_t Graph0_fy39[4] = { 22015, 1547.5, 182.5, 25.54688 };
   ...
   TH1F *Graph_Graph039 = new TH1F("Graph_Graph039","",100,0,0.366633);
   ...
   Graph_Graph039->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph039->GetXaxis()->SetRange(1,100);
   ...
   Double_t Graph_fy40[4] = { 2713.337, 91.18721, 0.4841, 2.550319e-05 };
   ...
   TH1F *Graph_Graph40 = new TH1F("Graph_Graph40","",100,0,0.366633);
   Graph_Graph40->SetMinimum(2.295287e-05);
   Graph_Graph40->SetMaximum(2984.67);
   ...
   Double_t Graph_fy42[4] = { 2984.67, 100.3059, 0.53251, 2.80535e-05 };
   ...
   TH1F *Graph_Graph42 = new TH1F("Graph_Graph42","",100,0,0.366633);
   Graph_Graph42->SetMinimum(2.524815e-05);
   Graph_Graph42->SetMaximum(3283.137);
