...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_0.00011()
{
...
//=========  (Mon Mar  2 03:15:02 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy134[4] = { 22015, 1547.5, 182.5, 25.54688 };
   ...
   TH1F *Graph_Graph0134 = new TH1F("Graph_Graph0134","",100,0,0.366633);
   ...
   Graph_Graph0134->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0134->GetXaxis()->SetRange(1,100);
   ...
   Double_t Graph1_fy135[10] = { 25963.95, 4705.702, 251.1274, 40.66906, 40.66906, 19.16016, 19.16016, 134.7363, 846.2891, 10921.5 };
   ...
   TH1F *Graph_Graph1135 = new TH1F("Graph_Graph1135","Graph",100,0,0.366633);
   Graph_Graph1135->SetMinimum(17.24414);
   Graph_Graph1135->SetMaximum(28558.43);
   ...
   Double_t Graph2_fy136[10] = { 22015.09, 2139.667, 212.6893, 31.96222, 31.96222, 21.55518, 21.55518, 157.1255, 1120.2, 20454.98 };
   ...
   TH1F *Graph_Graph2136 = new TH1F("Graph_Graph2136","Graph",100,0,0.366633);
   Graph_Graph2136->SetMinimum(19.39966);
   Graph_Graph2136->SetMaximum(24214.44);
   ...
   Double_t Graph0_fy137[4] = { 22015, 1547.5, 182.5, 25.54688 };
   ...
   TH1F *Graph_Graph0137 = new TH1F("Graph_Graph0137","",100,0,0.366633);
   ...
   Graph_Graph0137->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0137->GetXaxis()->SetRange(1,100);
   ...
   Double_t Graph_fy138[4] = { 19897.8, 668.7062, 3.550066, 0.0001870234 };
   ...
   TH1F *Graph_Graph138 = new TH1F("Graph_Graph138","",100,0,0.366633);
   Graph_Graph138->SetMinimum(0.000168321);
   Graph_Graph138->SetMaximum(21887.58);
   ...
   Double_t Graph_fy140[4] = { 21887.58, 735.5768, 3.905073, 0.0002057257 };
   ...
   TH1F *Graph_Graph140 = new TH1F("Graph_Graph140","",100,0,0.366633);
   Graph_Graph140->SetMinimum(0.0001851531);
   Graph_Graph140->SetMaximum(24076.34);
