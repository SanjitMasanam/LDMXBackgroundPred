...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_0.14()
{
...
//=========  (Mon Mar  2 03:15:03 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx533[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph0_fy533[4] = { 22015, 1547.5, 182.5, 25.54688 };
   TGraph *graph = new TGraph(4,Graph0_fx533,Graph0_fy533);
   ...
   TH1F *Graph_Graph0533 = new TH1F("Graph_Graph0533","",100,0,0.366633);
   ...
   Graph_Graph0533->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0533->GetXaxis()->SetRange(1,100);
   ...
   Graph_Graph0533->GetYaxis()->SetTitle("N_{sig}");
   ...
   Double_t Graph1_fx534[10] = { 0.000333, 0.003333, 0.033333, 0.333333, 0.333333, 0.333333, 0.333333, 0.033333, 0.003333, 0.000333 };
   Double_t Graph1_fy534[10] = { 25963.95, 4705.702, 251.1274, 40.66906, 40.66906, 19.16016, 19.16016, 134.7363, 846.2891, 10921.5 };
   graph = new TGraph(10,Graph1_fx534,Graph1_fy534);
   ...
   TH1F *Graph_Graph1534 = new TH1F("Graph_Graph1534","Graph",100,0,0.366633);
   Graph_Graph1534->SetMinimum(17.24414);
   Graph_Graph1534->SetMaximum(28558.43);
   ...
   Double_t Graph2_fx535[10] = { 0.000333, 0.003333, 0.033333, 0.333333, 0.333333, 0.333333, 0.333333, 0.033333, 0.003333, 0.000333 };
   Double_t Graph2_fy535[10] = { 22015.09, 2139.667, 212.6893, 31.96222, 31.96222, 21.55518, 21.55518, 157.1255, 1120.2, 20454.98 };
   graph = new TGraph(10,Graph2_fx535,Graph2_fy535);
   ...
   TH1F *Graph_Graph2535 = new TH1F("Graph_Graph2535","Graph",100,0,0.366633);
   Graph_Graph2535->SetMinimum(19.39966);
   Graph_Graph2535->SetMaximum(24214.44);
   ...
   Double_t Graph0_fx536[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph0_fy536[4] = { 22015, 1547.5, 182.5, 25.54688 };
   graph = new TGraph(4,Graph0_fx536,Graph0_fy536);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0536 = new TH1F("Graph_Graph0536","",100,0,0.366633);
   ...
   Graph_Graph0536->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0536->GetXaxis()->SetRange(1,100);
   ...
   Graph_Graph0536->GetYaxis()->SetTitle("N_{sig}");
   ...
   Double_t Graph_fx537[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph_fy537[4] = { 2.532448e+07, 851080.6, 4518.266, 0.2380297 };
   graph = new TGraph(4,Graph_fx537,Graph_fy537);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph537 = new TH1F("Graph_Graph537","",100,0,0.366633);
   Graph_Graph537->SetMinimum(0.2142268);
   Graph_Graph537->SetMaximum(2.785692e+07);
   ...
   Double_t Graph_fx539[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph_fy539[4] = { 2.785692e+07, 936188.7, 4970.093, 0.2618327 };
   graph = new TGraph(4,Graph_fx539,Graph_fy539);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph539 = new TH1F("Graph_Graph539","",100,0,0.366633);
   Graph_Graph539->SetMinimum(0.2356494);
   Graph_Graph539->SetMaximum(3.064262e+07);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(0.1554305,0,0.1554305,81.98273);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(0.1504305,0,"  0.16 TeV");
