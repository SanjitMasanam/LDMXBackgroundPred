...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_0.0014()
{
...
//=========  (Mon Mar  2 03:15:02 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy281[4] = { 22015, 1547.5, 182.5, 25.54688 };
   ...
   TH1F *Graph_Graph0281 = new TH1F("Graph_Graph0281","",100,0,0.366633);
   ...
   Graph_Graph0281->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0281->GetXaxis()->SetRange(1,100);
   ...
   Double_t Graph1_fy282[10] = { 25963.95, 4705.702, 251.1274, 40.66906, 40.66906, 19.16016, 19.16016, 134.7363, 846.2891, 10921.5 };
   ...
   TH1F *Graph_Graph1282 = new TH1F("Graph_Graph1282","Graph",100,0,0.366633);
   Graph_Graph1282->SetMinimum(17.24414);
   Graph_Graph1282->SetMaximum(28558.43);
   ...
   Double_t Graph2_fy283[10] = { 22015.09, 2139.667, 212.6893, 31.96222, 31.96222, 21.55518, 21.55518, 157.1255, 1120.2, 20454.98 };
   ...
   TH1F *Graph_Graph2283 = new TH1F("Graph_Graph2283","Graph",100,0,0.366633);
   Graph_Graph2283->SetMinimum(19.39966);
   Graph_Graph2283->SetMaximum(24214.44);
   ...
   Double_t Graph0_fy284[4] = { 22015, 1547.5, 182.5, 25.54688 };
   ...
   TH1F *Graph_Graph0284 = new TH1F("Graph_Graph0284","",100,0,0.366633);
   ...
   Graph_Graph0284->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0284->GetXaxis()->SetRange(1,100);
   ...
   Double_t Graph_fy285[4] = { 253244.8, 8510.806, 45.18266, 0.002380297 };
   ...
   TH1F *Graph_Graph285 = new TH1F("Graph_Graph285","",100,0,0.366633);
   Graph_Graph285->SetMinimum(0.002142268);
   Graph_Graph285->SetMaximum(278569.2);
   ...
   Double_t Graph_fy287[4] = { 278569.2, 9361.887, 49.70093, 0.002618327 };
   ...
   TH1F *Graph_Graph287 = new TH1F("Graph_Graph287","",100,0,0.366633);
   Graph_Graph287->SetMinimum(0.002356494);
   Graph_Graph287->SetMaximum(306426.2);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(0.01982616,0,0.01982616,477.7933);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(0.01482616,0,"  0.02 TeV");
