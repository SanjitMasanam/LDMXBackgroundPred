...
//=========  (Mon Mar  2 03:15:02 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy85[4] = { 22015, 1547.5, 182.5, 25.54688 };
   ...
   TH1F *Graph_Graph085 = new TH1F("Graph_Graph085","",100,0,0.366633);
   ...
   Graph_Graph085->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph085->GetXaxis()->SetRange(1,100);
   ...
   Double_t Graph1_fy86[10] = { 25963.95, 4705.702, 251.1274, 40.66906, 40.66906, 19.16016, 19.16016, 134.7363, 846.2891, 10921.5 };
   ...
   TH1F *Graph_Graph186 = new TH1F("Graph_Graph186","Graph",100,0,0.366633);
   Graph_Graph186->SetMinimum(17.24414);
   ...
   Double_t Graph2_fy87[10] = { 22015.09, 2139.667, 212.6893, 31.96222, 31.96222, 21.55518, 21.55518, 157.1255, 1120.2, 20454.98 };
   ...
   TH1F *Graph_Graph287 = new TH1F("Graph_Graph287","Graph",100,0,0.366633);
   Graph_Graph287->SetMinimum(19.39966);
   ...
   Double_t Graph0_fy88[4] = { 22015, 1547.5, 182.5, 25.54688 };
   ...
   TH1F *Graph_Graph088 = new TH1F("Graph_Graph088","",100,0,0.366633);
   ...
   Graph_Graph088->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph088->GetXaxis()->SetRange(1,100);
   ...
   Double_t Graph_fy89[4] = { 7235.564, 243.1659, 1.290933, 6.800849e-05 };
   ...
   TH1F *Graph_Graph89 = new TH1F("Graph_Graph89","",100,0,0.366633);
   Graph_Graph89->SetMinimum(6.120764e-05);
   Graph_Graph89->SetMaximum(7959.121);
   ...
   Double_t Graph_fy91[4] = { 7959.121, 267.4825, 1.420027, 7.480934e-05 };
   ...
   TH1F *Graph_Graph91 = new TH1F("Graph_Graph91","",100,0,0.366633);
   Graph_Graph91->SetMinimum(6.732841e-05);
   Graph_Graph91->SetMaximum(8755.033);
