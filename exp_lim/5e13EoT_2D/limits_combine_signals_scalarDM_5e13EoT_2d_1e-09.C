...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_1e-09()
{
...
//=========  (Tue Feb 24 10:30:54 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx1[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph0_fy1[4] = { 22015, 1525, 185.1562, 26.17188 };
   ...
   TH1F *Graph_Graph01 = new TH1F("Graph_Graph01","",100,0.0002997,0.366633);
   ...
   Graph_Graph01->GetXaxis()->SetTitle("m(#chi) [GeV]");
   ...
   Graph_Graph01->GetYaxis()->SetTitle("N_{Sig}");
   ...
   Double_t Graph1_fx2[10] = { 0.000333, 0.003333, 0.033333, 0.333333, 0.333333, 0.333333, 0.333333, 0.033333, 0.003333, 0.000333 };
   Double_t Graph1_fy2[10] = { 25974.92, 4637.283, 253.7817, 41.44204, 41.44204, 19.73114, 19.73114, 138.8672, 833.9844, 10663.52 };
   ...
   TH1F *Graph_Graph12 = new TH1F("Graph_Graph12","Graph",100,0.0002997,0.366633);
   Graph_Graph12->SetMinimum(17.75803);
   Graph_Graph12->SetMaximum(28570.44);
   ...
   Double_t Graph2_fx3[10] = { 0.000333, 0.003333, 0.033333, 0.333333, 0.333333, 0.333333, 0.333333, 0.033333, 0.003333, 0.000333 };
   Double_t Graph2_fy3[10] = { 22015.09, 2111.596, 215.2314, 32.63985, 32.63985, 22.0961, 22.0961, 161.2885, 1109.311, 20374.36 };
   ...
   TH1F *Graph_Graph23 = new TH1F("Graph_Graph23","Graph",100,0.0002997,0.366633);
   Graph_Graph23->SetMinimum(19.88649);
   Graph_Graph23->SetMaximum(24214.38);
   ...
   Double_t Graph0_fx4[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph0_fy4[4] = { 22015, 1525, 185.1562, 26.17188 };
   ...
   TH1F *Graph_Graph04 = new TH1F("Graph_Graph04","",100,0.0002997,0.366633);
   ...
   Graph_Graph04->GetXaxis()->SetTitle("m(#chi) [GeV]");
   ...
   Graph_Graph04->GetYaxis()->SetTitle("N_{Sig}");
   ...
   Double_t Graph_fx5[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph_fy5[4] = { 16.98104, 0.5700092, 0.003027476, 1.598181e-08 };
   ...
   TH1F *Graph_Graph5 = new TH1F("Graph_Graph5","",100,0.0002997,0.366633);
   Graph_Graph5->SetMinimum(1.438363e-08);
   Graph_Graph5->SetMaximum(18.67914);
   ...
   Double_t Graph_fx7[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph_fy7[4] = { 18.67914, 0.6270102, 0.003330223, 1.758e-08 };
   ...
   TH1F *Graph_Graph7 = new TH1F("Graph_Graph7","",100,0.0002997,0.366633);
   Graph_Graph7->SetMinimum(1.5822e-08);
   Graph_Graph7->SetMaximum(20.54705);
