...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_7e-05()
{
...
//=========  (Mon Mar  2 03:15:02 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy106[4] = { 22015, 1547.5, 182.5, 25.54688 };
   ...
   TH1F *Graph_Graph0106 = new TH1F("Graph_Graph0106","",100,0,0.366633);
   ...
   Graph_Graph0106->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0106->GetXaxis()->SetRange(1,100);
   ...
   Double_t Graph1_fy107[10] = { 25963.95, 4705.702, 251.1274, 40.66906, 40.66906, 19.16016, 19.16016, 134.7363, 846.2891, 10921.5 };
   ...
   TH1F *Graph_Graph1107 = new TH1F("Graph_Graph1107","Graph",100,0,0.366633);
   Graph_Graph1107->SetMinimum(17.24414);
   Graph_Graph1107->SetMaximum(28558.43);
   ...
   Double_t Graph2_fy108[10] = { 22015.09, 2139.667, 212.6893, 31.96222, 31.96222, 21.55518, 21.55518, 157.1255, 1120.2, 20454.98 };
   ...
   TH1F *Graph_Graph2108 = new TH1F("Graph_Graph2108","Graph",100,0,0.366633);
   Graph_Graph2108->SetMinimum(19.39966);
   Graph_Graph2108->SetMaximum(24214.44);
   ...
   Double_t Graph0_fy109[4] = { 22015, 1547.5, 182.5, 25.54688 };
   ...
   TH1F *Graph_Graph0109 = new TH1F("Graph_Graph0109","",100,0,0.366633);
   ...
   Graph_Graph0109->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0109->GetXaxis()->SetRange(1,100);
   ...
   Double_t Graph_fy110[4] = { 12662.24, 425.5403, 2.259133, 0.0001190149 };
   ...
   TH1F *Graph_Graph110 = new TH1F("Graph_Graph110","",100,0,0.366633);
   Graph_Graph110->SetMinimum(0.0001071134);
   Graph_Graph110->SetMaximum(13928.46);
   ...
   Double_t Graph_fy112[4] = { 13928.46, 468.0943, 2.485046, 0.0001309164 };
   ...
   TH1F *Graph_Graph112 = new TH1F("Graph_Graph112","",100,0,0.366633);
   Graph_Graph112->SetMinimum(0.0001178247);
   Graph_Graph112->SetMaximum(15321.31);
