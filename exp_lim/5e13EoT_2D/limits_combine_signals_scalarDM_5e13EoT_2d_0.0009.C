...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_0.0009()
{
...
//=========  (Mon Mar  2 03:15:02 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy246[4] = { 22015, 1547.5, 182.5, 25.54688 };
   ...
   TH1F *Graph_Graph0246 = new TH1F("Graph_Graph0246","",100,0,0.366633);
   ...
   Graph_Graph0246->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0246->GetXaxis()->SetRange(1,100);
   ...
   Double_t Graph1_fy247[10] = { 25963.95, 4705.702, 251.1274, 40.66906, 40.66906, 19.16016, 19.16016, 134.7363, 846.2891, 10921.5 };
   ...
   TH1F *Graph_Graph1247 = new TH1F("Graph_Graph1247","Graph",100,0,0.366633);
   Graph_Graph1247->SetMinimum(17.24414);
   Graph_Graph1247->SetMaximum(28558.43);
   ...
   Double_t Graph2_fy248[10] = { 22015.09, 2139.667, 212.6893, 31.96222, 31.96222, 21.55518, 21.55518, 157.1255, 1120.2, 20454.98 };
   ...
   TH1F *Graph_Graph2248 = new TH1F("Graph_Graph2248","Graph",100,0,0.366633);
   Graph_Graph2248->SetMinimum(19.39966);
   Graph_Graph2248->SetMaximum(24214.44);
   ...
   Double_t Graph0_fy249[4] = { 22015, 1547.5, 182.5, 25.54688 };
   ...
   TH1F *Graph_Graph0249 = new TH1F("Graph_Graph0249","",100,0,0.366633);
   ...
   Graph_Graph0249->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0249->GetXaxis()->SetRange(1,100);
   ...
   Double_t Graph_fy250[4] = { 162800.2, 5471.232, 29.046, 0.001530191 };
   ...
   TH1F *Graph_Graph250 = new TH1F("Graph_Graph250","",100,0,0.366633);
   Graph_Graph250->SetMinimum(0.001377172);
   Graph_Graph250->SetMaximum(179080.2);
   ...
   Double_t Graph_fy252[4] = { 179080.2, 6018.356, 31.9506, 0.00168321 };
   ...
   TH1F *Graph_Graph252 = new TH1F("Graph_Graph252","",100,0,0.366633);
   Graph_Graph252->SetMinimum(0.001514889);
   Graph_Graph252->SetMaximum(196988.2);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(0.01555137,0,0.01555137,647.9269);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(0.01055137,0,"  0.02 TeV");
