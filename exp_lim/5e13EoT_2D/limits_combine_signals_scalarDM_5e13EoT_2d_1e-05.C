...
//=========  (Mon Mar  2 03:15:02 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy1[4] = { 22015, 1547.5, 182.5, 25.54688 };
   ...
   TH1F *Graph_Graph01 = new TH1F("Graph_Graph01","",100,0,0.366633);
   ...
   Graph_Graph01->GetXaxis()->SetTitle("m(#chi) [MeV]");
   ...
   Double_t Graph1_fy2[10] = { 25963.95, 4705.702, 251.1274, 40.66906, 40.66906, 19.16016, 19.16016, 134.7363, 846.2891, 10921.5 };
   ...
   TH1F *Graph_Graph12 = new TH1F("Graph_Graph12","Graph",100,0,0.366633);
   Graph_Graph12->SetMinimum(17.24414);
   Graph_Graph12->SetMaximum(28558.43);
   ...
   Double_t Graph2_fy3[10] = { 22015.09, 2139.667, 212.6893, 31.96222, 31.96222, 21.55518, 21.55518, 157.1255, 1120.2, 20454.98 };
   ...
   TH1F *Graph_Graph23 = new TH1F("Graph_Graph23","Graph",100,0,0.366633);
   Graph_Graph23->SetMinimum(19.39966);
   Graph_Graph23->SetMaximum(24214.44);
   ...
   Double_t Graph0_fy4[4] = { 22015, 1547.5, 182.5, 25.54688 };
   ...
   TH1F *Graph_Graph04 = new TH1F("Graph_Graph04","",100,0,0.366633);
   ...
   Graph_Graph04->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph04->GetXaxis()->SetRange(1,100);
   ...
   Double_t Graph_fy5[4] = { 1808.891, 60.79147, 0.3227333, 1.700212e-05 };
   ...
   TH1F *Graph_Graph5 = new TH1F("Graph_Graph5","",100,0,0.366633);
   Graph_Graph5->SetMinimum(1.530191e-05);
   Graph_Graph5->SetMaximum(1989.78);
   ...
   Double_t Graph_fy7[4] = { 1989.78, 66.87062, 0.3550066, 1.870234e-05 };
   ...
   TH1F *Graph_Graph7 = new TH1F("Graph_Graph7","",100,0,0.366633);
   Graph_Graph7->SetMinimum(1.68321e-05);
   Graph_Graph7->SetMaximum(2188.758);
