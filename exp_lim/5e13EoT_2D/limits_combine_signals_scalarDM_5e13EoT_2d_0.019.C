...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_0.019()
{
...
//=========  (Mon Mar  2 03:15:03 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx442[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph0_fy442[4] = { 22015, 1547.5, 182.5, 25.54688 };
   TGraph *graph = new TGraph(4,Graph0_fx442,Graph0_fy442);
   ...
   TH1F *Graph_Graph0442 = new TH1F("Graph_Graph0442","",100,0,0.366633);
   ...
   Graph_Graph0442->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0442->GetXaxis()->SetRange(1,100);
   ...
   Graph_Graph0442->GetYaxis()->SetTitle("N_{sig}");
   ...
   Double_t Graph1_fx443[10] = { 0.000333, 0.003333, 0.033333, 0.333333, 0.333333, 0.333333, 0.333333, 0.033333, 0.003333, 0.000333 };
   Double_t Graph1_fy443[10] = { 25963.95, 4705.702, 251.1274, 40.66906, 40.66906, 19.16016, 19.16016, 134.7363, 846.2891, 10921.5 };
   graph = new TGraph(10,Graph1_fx443,Graph1_fy443);
   ...
   TH1F *Graph_Graph1443 = new TH1F("Graph_Graph1443","Graph",100,0,0.366633);
   Graph_Graph1443->SetMinimum(17.24414);
   Graph_Graph1443->SetMaximum(28558.43);
   ...
   Double_t Graph2_fx444[10] = { 0.000333, 0.003333, 0.033333, 0.333333, 0.333333, 0.333333, 0.333333, 0.033333, 0.003333, 0.000333 };
   Double_t Graph2_fy444[10] = { 22015.09, 2139.667, 212.6893, 31.96222, 31.96222, 21.55518, 21.55518, 157.1255, 1120.2, 20454.98 };
   graph = new TGraph(10,Graph2_fx444,Graph2_fy444);
   ...
   TH1F *Graph_Graph2444 = new TH1F("Graph_Graph2444","Graph",100,0,0.366633);
   Graph_Graph2444->SetMinimum(19.39966);
   Graph_Graph2444->SetMaximum(24214.44);
   ...
   Double_t Graph0_fx445[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph0_fy445[4] = { 22015, 1547.5, 182.5, 25.54688 };
   graph = new TGraph(4,Graph0_fx445,Graph0_fy445);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0445 = new TH1F("Graph_Graph0445","",100,0,0.366633);
   ...
   Graph_Graph0445->GetXaxis()->SetTitle("m(#chi) [MeV]");
   Graph_Graph0445->GetXaxis()->SetRange(1,100);
   ...
   Graph_Graph0445->GetYaxis()->SetTitle("N_{sig}");
   ...
   Double_t Graph_fx446[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph_fy446[4] = { 3436893, 115503.8, 613.1933, 0.03230403 };
   graph = new TGraph(4,Graph_fx446,Graph_fy446);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph446 = new TH1F("Graph_Graph446","",100,0,0.366633);
   Graph_Graph446->SetMinimum(0.02907363);
   Graph_Graph446->SetMaximum(3780582);
   ...
   Double_t Graph_fx448[4] = { 0.000333, 0.003333, 0.033333, 0.333333 };
   Double_t Graph_fy448[4] = { 3780582, 127054.2, 674.5126, 0.03553444 };
   graph = new TGraph(4,Graph_fx448,Graph_fy448);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph448 = new TH1F("Graph_Graph448","",100,0,0.366633);
   Graph_Graph448->SetMinimum(0.03198099);
   Graph_Graph448->SetMaximum(4158641);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(0.07944316,0,0.07944316,134.9007);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(0.07444316,0,"  0.08 TeV");
