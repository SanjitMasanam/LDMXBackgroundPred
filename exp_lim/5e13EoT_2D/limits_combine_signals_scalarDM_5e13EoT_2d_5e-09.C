...
#endif
void limits_combine_signals_scalarDM_5e13EoT_2d_5e-09()
{
...
//=========  (Tue Feb 24 10:30:54 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy15[4] = { 22015, 1525, 185.1562, 26.17188 };
   ...
   TH1F *Graph_Graph015 = new TH1F("Graph_Graph015","",100,0.0002997,0.366633);
   ...
   Graph_Graph015->GetXaxis()->SetTitle("m(#chi) [GeV]");
   Graph_Graph015->GetXaxis()->SetRange(0,101);
   ...
   Double_t Graph1_fy16[10] = { 25974.92, 4637.283, 253.7817, 41.44204, 41.44204, 19.73114, 19.73114, 138.8672, 833.9844, 10663.52 };
   ...
   TH1F *Graph_Graph116 = new TH1F("Graph_Graph116","Graph",100,0.0002997,0.366633);
   Graph_Graph116->SetMinimum(17.75803);
   Graph_Graph116->SetMaximum(28570.44);
   ...
   Double_t Graph2_fy17[10] = { 22015.09, 2111.596, 215.2314, 32.63985, 32.63985, 22.0961, 22.0961, 161.2885, 1109.311, 20374.36 };
   ...
   TH1F *Graph_Graph217 = new TH1F("Graph_Graph217","Graph",100,0.0002997,0.366633);
   Graph_Graph217->SetMinimum(19.88649);
   Graph_Graph217->SetMaximum(24214.38);
   ...
   Double_t Graph0_fy18[4] = { 22015, 1525, 185.1562, 26.17188 };
   ...
   TH1F *Graph_Graph018 = new TH1F("Graph_Graph018","",100,0.0002997,0.366633);
   ...
   Graph_Graph018->GetXaxis()->SetTitle("m(#chi) [GeV]");
   Graph_Graph018->GetXaxis()->SetRange(0,101);
   ...
   Double_t Graph_fy19[4] = { 84.90519, 2.850046, 0.01513738, 7.990907e-08 };
   ...
   TH1F *Graph_Graph19 = new TH1F("Graph_Graph19","",100,0.0002997,0.366633);
   Graph_Graph19->SetMinimum(7.191816e-08);
   Graph_Graph19->SetMaximum(93.3957);
   ...
   Double_t Graph_fy21[4] = { 93.3957, 3.135051, 0.01665112, 8.789998e-08 };
   ...
   TH1F *Graph_Graph21 = new TH1F("Graph_Graph21","",100,0.0002997,0.366633);
   Graph_Graph21->SetMinimum(7.910998e-08);
   Graph_Graph21->SetMaximum(102.7353);
